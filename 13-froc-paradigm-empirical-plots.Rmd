...
* Case 1, the first non-diseased case, has a single NL mark rated `r frocDataRaw$ratings$NL[1,1,1,1]` and the remaining 3 locations are filled with $-\infty$s. 

* Case 6, the first diseased case, has zero NL marks and all 4 locations for it are filled with $-\infty$s. 

* Case 11, the sixth diseased case, has three NL marks rated `r frocDataRaw$ratings$NL[1,1,11,1:3]` and the remaining location for it is $-\infty$. 
