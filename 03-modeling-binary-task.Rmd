...
```{r binaryTask-shaded-tails, fig.cap= "Illustrating that 95% of the total area under the unit normal pdf is contained in the range |Z| < 1.96, which can be used to construct a 95% confidence interval for an estimate of a suitably normalized statistic. The area contained in each shaded tail is 2.5%.", fig.show='hold'}
mu <- 0;sigma <- 1
zeta <- -qnorm(0.025)
step <- 0.1
...
kable(df, caption = "Effect of sample size on case-sampling variability of estimates of sensitivity, specificity and the separation parameter.", escape = FALSE)
```
