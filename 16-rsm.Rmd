...
```{r rsm-code-snippet-poisson-samples}
...
```{r rsm-code-snippet-poisson-samples-ci-100}
K <- 100
lambdaP <- c(1,2)
...
```{r rsm-code-snippet-poisson-samples-ci-10000}
K <- 10000
lambdaP <- c(1,2)
cat ("K = ", K,", lambdaP 1st reader = ", lambdaP[1],", lambdaP 2nd reader = ", lambdaP[2],"\n")
seed <- 1;set.seed(seed);samples1 <- rpois(K,lambda = lambdaP[1]);cat("obs. mean, reader 1 = ", mean(samples1), "\n")
...
```{r rsm-code-snippet-binomial-example1}
...
```{r rsm-code-snippet-binomial-example2}
