...
The partial-area measure is $A_{z;c}$ = `r A_zc`. The value is small because the reporting threshold is high. However, this is not be confused with true performance of the observer, as shown next.
