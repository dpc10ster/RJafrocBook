...
```{r binormal-model-youden-max, fig.cap="Left panel: binormal ROC curve corresponding to a = 2 and b = 1. Right panel: variation of Youden index with FPF; at FPF = 0.1586553 the plot shows a maximum; this point corresponds to the point of nearest approch of the ROC to the upper-left corner. The corresponding TPF is 0.8413447.", fig.show='hold', echo=FALSE}
grid.arrange(p1, p2, ncol = 2)
```
