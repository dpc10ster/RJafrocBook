...
<img src="06-binormal-model_files/figure-html/unnamed-chunk-4-1.png" width="672" />

Thsi plot shows operating points from Table 1, transformed by the $\Phi^{-1}$ function; the slope of the line is the least-squares estimate of the $b$ parameter and the intercept is the corresponding $a$ parameter of the binormal model.
