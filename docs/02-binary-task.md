...
<table>
<caption>(\#tab:binaryTask0truthTable)Truth Table.</caption>
 <thead>
  <tr>
...
<table>
<caption>(\#tab:binaryTask0truthTable2)Cell counts.</caption>
 <thead>
  <tr>
   <th style="text-align:left;">   </th>
   <th style="text-align:left;"> T=1 </th>
...
* Line 8 calculates `NPV` using Eqn. \@ref(eq:binaryTask0NPVFormula-pop). 
* Line 9 calculates `PPV` using Eqn. \@ref(eq:binaryTask0PPV). 
