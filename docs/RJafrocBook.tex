...
\CommentTok{\#\textgreater{} 1    1.2302291          1   0.26736248}
\end{Highlighting}
\end{Shaded}
...
\section{Random-reader fixed-case (RRFC) analysis}\label{ORAnalysisSigTesting-RRFCAnalysis}}
...
\chapter{Applications using the Obuchowski Rockette method}\label{ORApplications}}
...
\section{Hand calculation using dataset02}\label{ORApplications-dataset02-hand}}

Dataset \texttt{dataset02} is well-know in the literature \citep{RN1993} as it has been widely used to illustrate advances in ROC methodology. The following code extract the numbers of modalities, readers and cases for \texttt{dataset02} and defines strings \texttt{modalityID}, \texttt{readerID} and \texttt{diffTRName} that will be needed later on.
...
\item
  The following code uses \texttt{UtilFigureOfMerit()} to this end. Note that \texttt{FOM\ =\ "Wilcoxon"} has to be explicitly specified.
\end{itemize}
...
\KeywordTok{print}\NormalTok{(F\_ORH\_RRRC)}
...
\KeywordTok{print}\NormalTok{(trtMeans)}
\CommentTok{\#\textgreater{}      trt0      trt1 }
\CommentTok{\#\textgreater{} 0.8970370 0.9408374}
...
\KeywordTok{print}\NormalTok{(CI\_RRRC)}
...
\NormalTok{\}}
\KeywordTok{print}\NormalTok{(CI\_RRRC\_IndvlTrt)}
\CommentTok{\#\textgreater{}       Estimate     StdErr      DFi   CILower   CIUpper        Cov2i}
\CommentTok{\#\textgreater{} trt0 0.8970370 0.03317360 12.74465 0.8252236 0.9688505 0.0004839618}
\CommentTok{\#\textgreater{} trt1 0.9408374 0.02156637 12.71019 0.8941378 0.9875369 0.0002041879}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{FTests \textless{}{-}}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{MS =} \KeywordTok{c}\NormalTok{(vc}\OperatorTok{$}\NormalTok{TRanova[}\StringTok{"T"}\NormalTok{, }\StringTok{"MS"}\NormalTok{], den\_FRRC),}
                     ...
                     \DataTypeTok{stringsAsFactors =} \OtherTok{FALSE}\NormalTok{)}
\KeywordTok{print}\NormalTok{(FTests)}
\CommentTok{\#\textgreater{}                     MS    Chisq DF          p}
\CommentTok{\#\textgreater{} Treatment 0.0047961705 5.475953  1 0.01927984}
\CommentTok{\#\textgreater{} Error     0.0008758604       NA NA         NA}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ciDiffTrtFRRC \textless{}{-}}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{Estimate =}\NormalTok{ trtMeanDiffs, }
                            ...
                            \DataTypeTok{stringsAsFactors =} \OtherTok{FALSE}\NormalTok{)}
\KeywordTok{print}\NormalTok{(ciDiffTrtFRRC)}
\CommentTok{\#\textgreater{}              Estimate     StdErr         z      PrGTz     CILower     CIUpper}
\CommentTok{\#\textgreater{} trt0{-}trt1 {-}0.04380032 0.01871748 {-}2.340075 0.01927984 {-}0.08048591 {-}0.00711473}
\end{Highlighting}
\end{Shaded}
...
\StringTok{    }\KeywordTok{rbind}\NormalTok{(ciAvgRdrEachTrt, }
          \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{Estimate =}\NormalTok{ trtMeans[i], }
                     ...
                     \DataTypeTok{stringsAsFactors =} \OtherTok{FALSE}\NormalTok{))}
\NormalTok{\}}
\KeywordTok{print}\NormalTok{(ciAvgRdrEachTrt)}
\CommentTok{\#\textgreater{}       Estimate     StdErr  DF   CILower   CIUpper}
\CommentTok{\#\textgreater{} trt0 0.8970370 0.02428971 113 0.8494301 0.9446440}
\CommentTok{\#\textgreater{} trt1 0.9408374 0.01677632 113 0.9079564 0.9737183}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  \}}
\NormalTok{\}}
\KeywordTok{print}\NormalTok{(ciDiffTrtEachRdr)}
\CommentTok{\#\textgreater{}                    Estimate     StdErr          z      PrGTz     CILower}
\CommentTok{\#\textgreater{} rdr0::trt0{-}trt1 {-}0.02818035 0.02551213 {-}1.1045864 0.26933885 {-}0.07818322}
\CommentTok{\#\textgreater{} rdr1::trt0{-}trt1 {-}0.04653784 0.02630183 {-}1.7693768 0.07683102 {-}0.09808848}
\CommentTok{\#\textgreater{} rdr2::trt0{-}trt1 {-}0.01787440 0.03120965 {-}0.5727202 0.56683414 {-}0.07904418}
\CommentTok{\#\textgreater{} rdr3::trt0{-}trt1 {-}0.02624799 0.01729129 {-}1.5179891 0.12901715 {-}0.06013829}
\CommentTok{\#\textgreater{} rdr4::trt0{-}trt1 {-}0.10016103 0.04405746 {-}2.2734182 0.02300099 {-}0.18651207}
\CommentTok{\#\textgreater{}                      CIUpper}
\CommentTok{\#\textgreater{} rdr0::trt0{-}trt1  0.021822507}
\CommentTok{\#\textgreater{} rdr1::trt0{-}trt1  0.005012792}
\CommentTok{\#\textgreater{} rdr2::trt0{-}trt1  0.043295388}
\CommentTok{\#\textgreater{} rdr3::trt0{-}trt1  0.007642316}
\CommentTok{\#\textgreater{} rdr4::trt0{-}trt1 {-}0.013809995}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{DF =} \KeywordTok{c}\NormalTok{(I}\DecValTok{{-}1}\NormalTok{,(I}\DecValTok{{-}1}\NormalTok{)}\OperatorTok{*}\NormalTok{(J}\DecValTok{{-}1}\NormalTok{)), }
             ...
             \DataTypeTok{stringsAsFactors =} \OtherTok{FALSE}\NormalTok{)}
\KeywordTok{print}\NormalTok{(FTests\_RRFC)}
\CommentTok{\#\textgreater{}    DF           MS     F          p}
\CommentTok{\#\textgreater{} T   1 0.0047961705 8.704 0.04195875}
\CommentTok{\#\textgreater{} TR  4 0.0005510306    NA         NA}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{print}\NormalTok{(ciDiffTrt\_RRFC)}
\CommentTok{\#\textgreater{}              Estimate     StdErr DF         t      PrGTt     CILower}
\CommentTok{\#\textgreater{} trt0{-}trt1 {-}0.04380032 0.01484629  4 {-}2.950254 0.04195875 {-}0.08502022}
\CommentTok{\#\textgreater{}               CIUpper}
\CommentTok{\#\textgreater{} trt0{-}trt1 {-}0.00258042}
\end{Highlighting}
\end{Shaded}
...
\section{Using RJafroc: dataset02}\label{ORApplications-dataset02-RJafroc}}
...
\item
  ...
  \end{itemize}
\item
  \texttt{RRFC}, which in turn is a \texttt{list} object containing the following data frames:
...
\item
  The first member of this object, a \texttt{list} object named \texttt{FOMs}, is then displayed.
\item
...
\KeywordTok{print}\NormalTok{(st1}\OperatorTok{$}\NormalTok{FOMs)}
\CommentTok{\#\textgreater{} $foms}
\CommentTok{\#\textgreater{}            rdr0       rdr1       rdr2       rdr3       rdr4}
\CommentTok{\#\textgreater{} trt0 0.91964573 0.85877617 0.90386473 0.97310789 0.82979066}
\CommentTok{\#\textgreater{} trt1 0.94782609 0.90531401 0.92173913 0.99935588 0.92995169}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $trtMeans}
\CommentTok{\#\textgreater{}        Estimate}
\CommentTok{\#\textgreater{} trt0 0.89703704}
\CommentTok{\#\textgreater{} trt1 0.94083736}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $trtMeanDiffs}
\CommentTok{\#\textgreater{}               Estimate}
\CommentTok{\#\textgreater{} trt0{-}trt1 {-}0.043800322}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Displayed next are the variance components and mean-squares contained in the \texttt{ANOVA} \texttt{list} object.
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(st1}\OperatorTok{$}\NormalTok{ANOVA)}
\CommentTok{\#\textgreater{} $TRanova}
\CommentTok{\#\textgreater{}              SS DF            MS}
\CommentTok{\#\textgreater{} T  0.0047961705  1 0.00479617053}
\CommentTok{\#\textgreater{} R  0.0153448000  4 0.00383619999}
\CommentTok{\#\textgreater{} TR 0.0022041225  4 0.00055103062}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $VarCom}
\CommentTok{\#\textgreater{}           Estimates       Rhos}
\CommentTok{\#\textgreater{} VarR  0.00153499935         NA}
\CommentTok{\#\textgreater{} VarTR 0.00020040252         NA}
\CommentTok{\#\textgreater{} Cov1  0.00034661371 0.43203138}
\CommentTok{\#\textgreater{} Cov2  0.00034407483 0.42886683}
\CommentTok{\#\textgreater{} Cov3  0.00023902837 0.29793328}
\CommentTok{\#\textgreater{} Var   0.00080228827         NA}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $IndividualTrt}
\CommentTok{\#\textgreater{}      DF   msREachTrt    varEachTrt   cov2EachTrt}
\CommentTok{\#\textgreater{} trt0  4 0.0030826287 0.00101410277 0.00048396180}
\CommentTok{\#\textgreater{} trt1  4 0.0013046019 0.00059047376 0.00020418785}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $IndividualRdr}
\CommentTok{\#\textgreater{}      DF    msTEachRdr    varEachRdr   cov1EachRdr}
\CommentTok{\#\textgreater{} rdr0  1 0.00039706618 0.00069890056 3.7346610e{-}04}
\CommentTok{\#\textgreater{} rdr1  1 0.00108288538 0.00110605283 7.6015978e{-}04}
\CommentTok{\#\textgreater{} rdr2  1 0.00015974702 0.00084234345 3.5532241e{-}04}
\CommentTok{\#\textgreater{} rdr3  1 0.00034447841 0.00015057773 1.0833995e{-}06}
\CommentTok{\#\textgreater{} rdr4  1 0.00501611603 0.00121356676 2.4303685e{-}04}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(st1}\OperatorTok{$}\NormalTok{RRRC}\OperatorTok{$}\NormalTok{FTests)}
\CommentTok{\#\textgreater{}                  DF           MS     FStat           p}
\CommentTok{\#\textgreater{} Treatment  1.000000 0.0047961705 4.4563187 0.051665686}
\CommentTok{\#\textgreater{} Error     15.259675 0.0010762629        NA          NA}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(st1}\OperatorTok{$}\NormalTok{RRRC}\OperatorTok{$}\NormalTok{ciDiffTrt[,}\OperatorTok{{-}}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\OperatorTok{:}\DecValTok{5}\NormalTok{)])}
\CommentTok{\#\textgreater{}               Estimate      CILower       CIUpper}
\CommentTok{\#\textgreater{} trt0{-}trt1 {-}0.043800322 {-}0.087959499 0.00035885444}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(st1}\OperatorTok{$}\NormalTok{RRRC}\OperatorTok{$}\NormalTok{ciAvgRdrEachTrt)}
\CommentTok{\#\textgreater{}        Estimate      StdErr        DF    CILower    CIUpper          Cov2}
\CommentTok{\#\textgreater{} trt0 0.89703704 0.033173597 12.744648 0.82522360 0.96885048 0.00048396180}
\CommentTok{\#\textgreater{} trt1 0.94083736 0.021566368 12.710190 0.89413783 0.98753689 0.00020418785}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(st1}\OperatorTok{$}\NormalTok{FRRC}\OperatorTok{$}\NormalTok{FTests)}
\CommentTok{\#\textgreater{}                      MS     Chisq DF           p}
\CommentTok{\#\textgreater{} Treatment 0.00479617053 5.4759532  1 0.019279843}
\CommentTok{\#\textgreater{} Error     0.00087586039        NA NA          NA}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(st1}\OperatorTok{$}\NormalTok{FRRC}\OperatorTok{$}\NormalTok{ciDiffTrt)}
\CommentTok{\#\textgreater{}               Estimate      StdErr          z       PrGTz      CILower}
\CommentTok{\#\textgreater{} trt0{-}trt1 {-}0.043800322 0.018717483 {-}2.3400755 0.019279843 {-}0.080485914}
\CommentTok{\#\textgreater{}                 CIUpper}
\CommentTok{\#\textgreater{} trt0{-}trt1 {-}0.0071147303}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(st1}\OperatorTok{$}\NormalTok{FRRC}\OperatorTok{$}\NormalTok{ciAvgRdrEachTrt)}
\CommentTok{\#\textgreater{}        Estimate      StdErr  DF    CILower    CIUpper}
\CommentTok{\#\textgreater{} trt0 0.89703704 0.024289710 113 0.84943008 0.94464399}
\CommentTok{\#\textgreater{} trt1 0.94083736 0.016776324 113 0.90795637 0.97371835}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(st1}\OperatorTok{$}\NormalTok{FRRC}\OperatorTok{$}\NormalTok{ciDiffTrtEachRdr)}
\CommentTok{\#\textgreater{}                     Estimate      StdErr           z       PrGTz      CILower}
\CommentTok{\#\textgreater{} rdr0::trt0{-}trt1 {-}0.028180354 0.025512133 {-}1.10458638 0.269338854 {-}0.078183215}
\CommentTok{\#\textgreater{} rdr1::trt0{-}trt1 {-}0.046537842 0.026301827 {-}1.76937679 0.076831017 {-}0.098088476}
\CommentTok{\#\textgreater{} rdr2::trt0{-}trt1 {-}0.017874396 0.031209647 {-}0.57272023 0.566834139 {-}0.079044180}
\CommentTok{\#\textgreater{} rdr3::trt0{-}trt1 {-}0.026247987 0.017291289 {-}1.51798907 0.129017153 {-}0.060138290}
\CommentTok{\#\textgreater{} rdr4::trt0{-}trt1 {-}0.100161031 0.044057460 {-}2.27341816 0.023000993 {-}0.186512066}
\CommentTok{\#\textgreater{}                       CIUpper}
\CommentTok{\#\textgreater{} rdr0::trt0{-}trt1  0.0218225068}
\CommentTok{\#\textgreater{} rdr1::trt0{-}trt1  0.0050127916}
\CommentTok{\#\textgreater{} rdr2::trt0{-}trt1  0.0432953879}
\CommentTok{\#\textgreater{} rdr3::trt0{-}trt1  0.0076423157}
\CommentTok{\#\textgreater{} rdr4::trt0{-}trt1 {-}0.0138099949}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(st1}\OperatorTok{$}\NormalTok{RRFC}\OperatorTok{$}\NormalTok{FTests)}
\CommentTok{\#\textgreater{}    DF            MS     F           p}
\CommentTok{\#\textgreater{} T   1 0.00479617053 8.704 0.041958752}
\CommentTok{\#\textgreater{} TR  4 0.00055103062    NA          NA}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(st1}\OperatorTok{$}\NormalTok{RRFC}\OperatorTok{$}\NormalTok{ciDiffTrt)}
\CommentTok{\#\textgreater{}               Estimate      StdErr DF          t       PrGTt      CILower}
\CommentTok{\#\textgreater{} trt0{-}trt1 {-}0.043800322 0.014846287  4 {-}2.9502542 0.041958752 {-}0.085020224}
\CommentTok{\#\textgreater{}                 CIUpper}
\CommentTok{\#\textgreater{} trt0{-}trt1 {-}0.0025804202}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(st1}\OperatorTok{$}\NormalTok{RRFC}\OperatorTok{$}\NormalTok{ciAvgRdrEachTrt)}
\CommentTok{\#\textgreater{}        Estimate      StdErr DF    CILower    CIUpper}
\CommentTok{\#\textgreater{} Trt0 0.89703704 0.024829936  4 0.82809808 0.96597599}
\CommentTok{\#\textgreater{} Trt1 0.94083736 0.016153030  4 0.89598936 0.98568536}
\end{Highlighting}
\end{Shaded}
...
\section{Using RJafroc: dataset04}\label{ORApplications-dataset04-RJafroc}}
...
\KeywordTok{print}\NormalTok{(st2)}
\CommentTok{\#\textgreater{} $FOMs}
...
\CommentTok{\#\textgreater{}       Estimate}
\CommentTok{\#\textgreater{} trt1 0.8451625}
\CommentTok{\#\textgreater{} trt2 0.8502625}
\CommentTok{\#\textgreater{} trt3 0.8098375}
\CommentTok{\#\textgreater{} trt4 0.8505750}
\CommentTok{\#\textgreater{} trt5 0.8083875}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $FOMs$trtMeanDiffs}
\CommentTok{\#\textgreater{}             Estimate}
\CommentTok{\#\textgreater{} trt1{-}trt2 {-}0.0051000}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.0353250}
\CommentTok{\#\textgreater{} trt1{-}trt4 {-}0.0054125}
\CommentTok{\#\textgreater{} trt1{-}trt5  0.0367750}
\CommentTok{\#\textgreater{} trt2{-}trt3  0.0404250}
\CommentTok{\#\textgreater{} trt2{-}trt4 {-}0.0003125}
\CommentTok{\#\textgreater{} trt2{-}trt5  0.0418750}
\CommentTok{\#\textgreater{} trt3{-}trt4 {-}0.0407375}
\CommentTok{\#\textgreater{} trt3{-}trt5  0.0014500}
\CommentTok{\#\textgreater{} trt4{-}trt5  0.0421875}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $ANOVA}
\CommentTok{\#\textgreater{} $ANOVA$TRanova}
\CommentTok{\#\textgreater{}              SS DF            MS}
\CommentTok{\#\textgreater{} T  0.0075878295  4 0.00189695737}
\CommentTok{\#\textgreater{} R  0.0218825325  3 0.00729417750}
\CommentTok{\#\textgreater{} TR 0.0055464825 12 0.00046220687}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $ANOVA$VarCom}
\CommentTok{\#\textgreater{}            Estimates       Rhos}
\CommentTok{\#\textgreater{} VarR   1.2837211e{-}03         NA}
\CommentTok{\#\textgreater{} VarTR {-}1.0925227e{-}05         NA}
\CommentTok{\#\textgreater{} Cov1   2.9480096e{-}04 0.37358228}
\CommentTok{\#\textgreater{} Cov2   2.3331406e{-}04 0.29566389}
\CommentTok{\#\textgreater{} Cov3   2.1212789e{-}04 0.26881601}
\CommentTok{\#\textgreater{} Var    7.8911924e{-}04         NA}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $ANOVA$IndividualTrt}
\CommentTok{\#\textgreater{}      DF    msREachTrt    varEachTrt   cov2EachTrt}
\CommentTok{\#\textgreater{} trt1  3 0.00242212063 0.00071052519 0.00021118589}
\CommentTok{\#\textgreater{} trt2  3 0.00052256229 0.00075105717 0.00026649085}
\CommentTok{\#\textgreater{} trt3  3 0.00185459062 0.00087586914 0.00024646233}
\CommentTok{\#\textgreater{} trt4  3 0.00257777083 0.00072651505 0.00022042897}
\CommentTok{\#\textgreater{} trt5  3 0.00176596062 0.00088162963 0.00022200226}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $ANOVA$IndividualRdr}
\CommentTok{\#\textgreater{}      DF   msTEachRdr    varEachRdr   cov1EachRdr}
\CommentTok{\#\textgreater{} rdr1  4 0.0015505755 0.00068948369 0.00021527296}
\CommentTok{\#\textgreater{} rdr2  4 0.0007942725 0.00082356314 0.00034557909}
\CommentTok{\#\textgreater{} rdr3  4 0.0007856530 0.00100854171 0.00035359299}
\CommentTok{\#\textgreater{} rdr4  4 0.0001530770 0.00063488840 0.00026475880}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $RRRC}
\CommentTok{\#\textgreater{} $RRRC$FTests}
\CommentTok{\#\textgreater{}                  DF            MS     FStat           p}
\CommentTok{\#\textgreater{} Treatment  4.000000 0.00189695737 3.4682364 0.030544556}
\CommentTok{\#\textgreater{} Error     16.803749 0.00054695157        NA          NA}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $RRRC$ciDiffTrt}
\CommentTok{\#\textgreater{}             Estimate      StdErr        DF            t       PrGTt}
\CommentTok{\#\textgreater{} trt1{-}trt2 {-}0.0051000 0.016537103 16.803749 {-}0.308397420 0.761570284}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.0353250 0.016537103 16.803749  2.136105659 0.047689094}
\CommentTok{\#\textgreater{} trt1{-}trt4 {-}0.0054125 0.016537103 16.803749 {-}0.327294321 0.747487331}
\CommentTok{\#\textgreater{} trt1{-}trt5  0.0367750 0.016537103 16.803749  2.223787278 0.040173758}
\CommentTok{\#\textgreater{} trt2{-}trt3  0.0404250 0.016537103 16.803749  2.444503079 0.025841064}
\CommentTok{\#\textgreater{} trt2{-}trt4 {-}0.0003125 0.016537103 16.803749 {-}0.018896901 0.985145919}
\CommentTok{\#\textgreater{} trt2{-}trt5  0.0418750 0.016537103 16.803749  2.532184698 0.021613616}
\CommentTok{\#\textgreater{} trt3{-}trt4 {-}0.0407375 0.016537103 16.803749 {-}2.463399980 0.024868769}
\CommentTok{\#\textgreater{} trt3{-}trt5  0.0014500 0.016537103 16.803749  0.087681619 0.931166167}
\CommentTok{\#\textgreater{} trt4{-}trt5  0.0421875 0.016537103 16.803749  2.551081599 0.020792673}
\CommentTok{\#\textgreater{}                  CILower       CIUpper}
\CommentTok{\#\textgreater{} trt1{-}trt2 {-}0.04002130451  0.0298213045}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.00040369549  0.0702463045}
\CommentTok{\#\textgreater{} trt1{-}trt4 {-}0.04033380451  0.0295088045}
\CommentTok{\#\textgreater{} trt1{-}trt5  0.00185369549  0.0716963045}
\CommentTok{\#\textgreater{} trt2{-}trt3  0.00550369549  0.0753463045}
\CommentTok{\#\textgreater{} trt2{-}trt4 {-}0.03523380451  0.0346088045}
\CommentTok{\#\textgreater{} trt2{-}trt5  0.00695369549  0.0767963045}
\CommentTok{\#\textgreater{} trt3{-}trt4 {-}0.07565880451 {-}0.0058161955}
\CommentTok{\#\textgreater{} trt3{-}trt5 {-}0.03347130451  0.0363713045}
\CommentTok{\#\textgreater{} trt4{-}trt5  0.00726619549  0.0771088045}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $RRRC$ciAvgRdrEachTrt}
\CommentTok{\#\textgreater{}       Estimate      StdErr         DF    CILower    CIUpper          Cov2}
\CommentTok{\#\textgreater{} trt1 0.8451625 0.028578244  5.4574766 0.77351391 0.91681109 0.00021118589}
\CommentTok{\#\textgreater{} trt2 0.8502625 0.019928157 27.7225775 0.80942311 0.89110189 0.00026649085}
\CommentTok{\#\textgreater{} trt3 0.8098375 0.026647889  7.0371428 0.74689261 0.87278239 0.00024646233}
\CommentTok{\#\textgreater{} trt4 0.8505750 0.029408701  5.4032614 0.77664342 0.92450658 0.00022042897}
\CommentTok{\#\textgreater{} trt5 0.8083875 0.025758346  6.7756525 0.74706746 0.86970754 0.00022200226}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $FRRC}
\CommentTok{\#\textgreater{} $FRRC$FTests}
\CommentTok{\#\textgreater{}                     MS     Chisq DF            p}
\CommentTok{\#\textgreater{} Treatment 0.0018969574 13.601264  4 0.0086826618}
\CommentTok{\#\textgreater{} Error     0.0005578768        NA NA           NA}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $FRRC$ciDiffTrt}
\CommentTok{\#\textgreater{}             Estimate      StdErr            z       PrGTz       CILower}
\CommentTok{\#\textgreater{} trt1{-}trt2 {-}0.0051000 0.016701449 {-}0.305362726 0.760089908 {-}0.0378342386}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.0353250 0.016701449  2.115085938 0.034422624  0.0025907614}
\CommentTok{\#\textgreater{} trt1{-}trt4 {-}0.0054125 0.016701449 {-}0.324073677 0.745882255 {-}0.0381467386}
\CommentTok{\#\textgreater{} trt1{-}trt5  0.0367750 0.016701449  2.201904752 0.027672037  0.0040407614}
\CommentTok{\#\textgreater{} trt2{-}trt3  0.0404250 0.016701449  2.420448663 0.015501368  0.0076907614}
\CommentTok{\#\textgreater{} trt2{-}trt4 {-}0.0003125 0.016701449 {-}0.018710951 0.985071692 {-}0.0330467386}
\CommentTok{\#\textgreater{} trt2{-}trt5  0.0418750 0.016701449  2.507267477 0.012166860  0.0091407614}
\CommentTok{\#\textgreater{} trt3{-}trt4 {-}0.0407375 0.016701449 {-}2.439159615 0.014721464 {-}0.0734717386}
\CommentTok{\#\textgreater{} trt3{-}trt5  0.0014500 0.016701449  0.086818814 0.930815533 {-}0.0312842386}
\CommentTok{\#\textgreater{} trt4{-}trt5  0.0421875 0.016701449  2.525978429 0.011537657  0.0094532614}
\CommentTok{\#\textgreater{}                 CIUpper}
\CommentTok{\#\textgreater{} trt1{-}trt2  0.0276342386}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.0680592386}
\CommentTok{\#\textgreater{} trt1{-}trt4  0.0273217386}
\CommentTok{\#\textgreater{} trt1{-}trt5  0.0695092386}
\CommentTok{\#\textgreater{} trt2{-}trt3  0.0731592386}
\CommentTok{\#\textgreater{} trt2{-}trt4  0.0324217386}
\CommentTok{\#\textgreater{} trt2{-}trt5  0.0746092386}
\CommentTok{\#\textgreater{} trt3{-}trt4 {-}0.0080032614}
\CommentTok{\#\textgreater{} trt3{-}trt5  0.0341842386}
\CommentTok{\#\textgreater{} trt4{-}trt5  0.0749217386}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $FRRC$ciAvgRdrEachTrt}
\CommentTok{\#\textgreater{}       Estimate      StdErr  DF    CILower    CIUpper}
\CommentTok{\#\textgreater{} trt1 0.8451625 0.018330868 199 0.80923466 0.88109034}
\CommentTok{\#\textgreater{} trt2 0.8502625 0.019688383 199 0.81167398 0.88885102}
\CommentTok{\#\textgreater{} trt3 0.8098375 0.020095125 199 0.77045178 0.84922322}
\CommentTok{\#\textgreater{} trt4 0.8505750 0.018626607 199 0.81406752 0.88708248}
\CommentTok{\#\textgreater{} trt5 0.8083875 0.019670005 199 0.76983500 0.84694000}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $FRRC$ciDiffTrtEachRdr}
\CommentTok{\#\textgreater{}                 Estimate      StdErr            z        PrGTz       CILower}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt2  0.04000 0.030796452  1.298850908 0.1939950999 {-}0.0203599373}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt3  0.09130 0.030796452  2.964627198 0.0030304993  0.0309400627}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt4  0.00190 0.030796452  0.061695418 0.9508053888 {-}0.0584599373}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt5  0.06285 0.030796452  2.040819490 0.0412687726  0.0024900627}
\CommentTok{\#\textgreater{} rdr1::trt2{-}trt3  0.05130 0.030796452  1.665776290 0.0957579803 {-}0.0090599373}
\CommentTok{\#\textgreater{} rdr1::trt2{-}trt4 {-}0.03810 0.030796452 {-}1.237155490 0.2160293623 {-}0.0984599373}
\CommentTok{\#\textgreater{} rdr1::trt2{-}trt5  0.02285 0.030796452  0.741968581 0.4581063718 {-}0.0375099373}
\CommentTok{\#\textgreater{} rdr1::trt3{-}trt4 {-}0.08940 0.030796452 {-}2.902931780 0.0036968716 {-}0.1497599373}
\CommentTok{\#\textgreater{} rdr1::trt3{-}trt5 {-}0.02845 0.030796452 {-}0.923807708 0.3555864411 {-}0.0888099373}
\CommentTok{\#\textgreater{} rdr1::trt4{-}trt5  0.06095 0.030796452  1.979124071 0.0478020389  0.0005900627}
\CommentTok{\#\textgreater{} rdr2::trt1{-}trt2 {-}0.04650 0.030918734 {-}1.503942569 0.1325961549 {-}0.1070996048}
\CommentTok{\#\textgreater{} rdr2::trt1{-}trt3 {-}0.01815 0.030918734 {-}0.587022745 0.5571884312 {-}0.0787496048}
\CommentTok{\#\textgreater{} rdr2::trt1{-}trt4 {-}0.03330 0.030918734 {-}1.077016936 0.2814726994 {-}0.0938996048}
\CommentTok{\#\textgreater{} rdr2::trt1{-}trt5  0.02520 0.030918734  0.815039844 0.4150495035 {-}0.0353996048}
\CommentTok{\#\textgreater{} rdr2::trt2{-}trt3  0.02835 0.030918734  0.916919824 0.3591846549 {-}0.0322496048}
\CommentTok{\#\textgreater{} rdr2::trt2{-}trt4  0.01320 0.030918734  0.426925632 0.6694334951 {-}0.0473996048}
\CommentTok{\#\textgreater{} rdr2::trt2{-}trt5  0.07170 0.030918734  2.318982413 0.0203959900  0.0111003952}
\CommentTok{\#\textgreater{} rdr2::trt3{-}trt4 {-}0.01515 0.030918734 {-}0.489994192 0.6241380088 {-}0.0757496048}
\CommentTok{\#\textgreater{} rdr2::trt3{-}trt5  0.04335 0.030918734  1.402062588 0.1608965575 {-}0.0172496048}
\CommentTok{\#\textgreater{} rdr2::trt4{-}trt5  0.05850 0.030918734  1.892056780 0.0584834160 {-}0.0020996048}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt2 {-}0.00875 0.036192505 {-}0.241762762 0.8089639949 {-}0.0796860066}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt3  0.05900 0.036192505  1.630171765 0.1030651996 {-}0.0119360066}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt4  0.02310 0.036192505  0.638253691 0.5233085518 {-}0.0478360066}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt5  0.04060 0.036192505  1.121779214 0.2619563260 {-}0.0303360066}
\CommentTok{\#\textgreater{} rdr3::trt2{-}trt3  0.06775 0.036192505  1.871934526 0.0612156622 {-}0.0031860066}
\CommentTok{\#\textgreater{} rdr3::trt2{-}trt4  0.03185 0.036192505  0.880016453 0.3788503968 {-}0.0390860066}
\CommentTok{\#\textgreater{} rdr3::trt2{-}trt5  0.04935 0.036192505  1.363541976 0.1727117647 {-}0.0215860066}
\CommentTok{\#\textgreater{} rdr3::trt3{-}trt4 {-}0.03590 0.036192505 {-}0.991918074 0.3212374917 {-}0.1068360066}
\CommentTok{\#\textgreater{} rdr3::trt3{-}trt5 {-}0.01840 0.036192505 {-}0.508392550 0.6111780762 {-}0.0893360066}
\CommentTok{\#\textgreater{} rdr3::trt4{-}trt5  0.01750 0.036192505  0.483525523 0.6287226416 {-}0.0534360066}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt2 {-}0.00515 0.027207705 {-}0.189284617 0.8498697516 {-}0.0584761218}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt3  0.00915 0.027207705  0.336301795 0.7366432968 {-}0.0441761218}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt4 {-}0.01335 0.027207705 {-}0.490669831 0.6236599874 {-}0.0666761218}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt5  0.01845 0.027207705  0.678116733 0.4976976819 {-}0.0348761218}
\CommentTok{\#\textgreater{} rdr4::trt2{-}trt3  0.01430 0.027207705  0.525586411 0.5991756003 {-}0.0390261218}
\CommentTok{\#\textgreater{} rdr4::trt2{-}trt4 {-}0.00820 0.027207705 {-}0.301385215 0.7631207674 {-}0.0615261218}
\CommentTok{\#\textgreater{} rdr4::trt2{-}trt5  0.02360 0.027207705  0.867401350 0.3857221425 {-}0.0297261218}
\CommentTok{\#\textgreater{} rdr4::trt3{-}trt4 {-}0.02250 0.027207705 {-}0.826971626 0.4082531440 {-}0.0758261218}
\CommentTok{\#\textgreater{} rdr4::trt3{-}trt5  0.00930 0.027207705  0.341814939 0.7324901666 {-}0.0440261218}
\CommentTok{\#\textgreater{} rdr4::trt4{-}trt5  0.03180 0.027207705  1.168786565 0.2424896348 {-}0.0215261218}
\CommentTok{\#\textgreater{}                      CIUpper}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt2  0.100359937}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt3  0.151659937}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt4  0.062259937}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt5  0.123209937}
\CommentTok{\#\textgreater{} rdr1::trt2{-}trt3  0.111659937}
\CommentTok{\#\textgreater{} rdr1::trt2{-}trt4  0.022259937}
\CommentTok{\#\textgreater{} rdr1::trt2{-}trt5  0.083209937}
\CommentTok{\#\textgreater{} rdr1::trt3{-}trt4 {-}0.029040063}
\CommentTok{\#\textgreater{} rdr1::trt3{-}trt5  0.031909937}
\CommentTok{\#\textgreater{} rdr1::trt4{-}trt5  0.121309937}
\CommentTok{\#\textgreater{} rdr2::trt1{-}trt2  0.014099605}
\CommentTok{\#\textgreater{} rdr2::trt1{-}trt3  0.042449605}
\CommentTok{\#\textgreater{} rdr2::trt1{-}trt4  0.027299605}
\CommentTok{\#\textgreater{} rdr2::trt1{-}trt5  0.085799605}
\CommentTok{\#\textgreater{} rdr2::trt2{-}trt3  0.088949605}
\CommentTok{\#\textgreater{} rdr2::trt2{-}trt4  0.073799605}
\CommentTok{\#\textgreater{} rdr2::trt2{-}trt5  0.132299605}
\CommentTok{\#\textgreater{} rdr2::trt3{-}trt4  0.045449605}
\CommentTok{\#\textgreater{} rdr2::trt3{-}trt5  0.103949605}
\CommentTok{\#\textgreater{} rdr2::trt4{-}trt5  0.119099605}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt2  0.062186007}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt3  0.129936007}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt4  0.094036007}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt5  0.111536007}
\CommentTok{\#\textgreater{} rdr3::trt2{-}trt3  0.138686007}
\CommentTok{\#\textgreater{} rdr3::trt2{-}trt4  0.102786007}
\CommentTok{\#\textgreater{} rdr3::trt2{-}trt5  0.120286007}
\CommentTok{\#\textgreater{} rdr3::trt3{-}trt4  0.035036007}
\CommentTok{\#\textgreater{} rdr3::trt3{-}trt5  0.052536007}
\CommentTok{\#\textgreater{} rdr3::trt4{-}trt5  0.088436007}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt2  0.048176122}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt3  0.062476122}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt4  0.039976122}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt5  0.071776122}
\CommentTok{\#\textgreater{} rdr4::trt2{-}trt3  0.067626122}
\CommentTok{\#\textgreater{} rdr4::trt2{-}trt4  0.045126122}
\CommentTok{\#\textgreater{} rdr4::trt2{-}trt5  0.076926122}
\CommentTok{\#\textgreater{} rdr4::trt3{-}trt4  0.030826122}
\CommentTok{\#\textgreater{} rdr4::trt3{-}trt5  0.062626122}
\CommentTok{\#\textgreater{} rdr4::trt4{-}trt5  0.085126122}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $FRRC$IndividualRdrVarCov1}
\CommentTok{\#\textgreater{}         varEachRdr   cov1EachRdr}
\CommentTok{\#\textgreater{} rdr1 0.00068948369 0.00021527296}
\CommentTok{\#\textgreater{} rdr2 0.00082356314 0.00034557909}
\CommentTok{\#\textgreater{} rdr3 0.00100854171 0.00035359299}
\CommentTok{\#\textgreater{} rdr4 0.00063488840 0.00026475880}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $RRFC}
\CommentTok{\#\textgreater{} $RRFC$FTests}
\CommentTok{\#\textgreater{}    DF            MS         F           p}
\CommentTok{\#\textgreater{} T   4 0.00189695737 4.1041306 0.025328308}
\CommentTok{\#\textgreater{} TR 12 0.00046220687        NA          NA}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $RRFC$ciDiffTrt}
\CommentTok{\#\textgreater{}             Estimate      StdErr DF            t       PrGTt       CILower}
\CommentTok{\#\textgreater{} trt1{-}trt2 {-}0.0051000 0.015202087 12 {-}0.335480262 0.743055139 {-}0.0382225014}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.0353250 0.015202087 12  2.323694167 0.038508394  0.0022024986}
\CommentTok{\#\textgreater{} trt1{-}trt4 {-}0.0054125 0.015202087 12 {-}0.356036651 0.727993972 {-}0.0385350014}
\CommentTok{\#\textgreater{} trt1{-}trt5  0.0367750 0.015202087 12  2.419075810 0.032372026  0.0036524986}
\CommentTok{\#\textgreater{} trt2{-}trt3  0.0404250 0.015202087 12  2.659174429 0.020823153  0.0073024986}
\CommentTok{\#\textgreater{} trt2{-}trt4 {-}0.0003125 0.015202087 12 {-}0.020556389 0.983937382 {-}0.0334350014}
\CommentTok{\#\textgreater{} trt2{-}trt5  0.0418750 0.015202087 12  2.754556072 0.017454332  0.0087524986}
\CommentTok{\#\textgreater{} trt3{-}trt4 {-}0.0407375 0.015202087 12 {-}2.679730818 0.020046910 {-}0.0738600014}
\CommentTok{\#\textgreater{} trt3{-}trt5  0.0014500 0.015202087 12  0.095381643 0.925585993 {-}0.0316725014}
\CommentTok{\#\textgreater{} trt4{-}trt5  0.0421875 0.015202087 12  2.775112461 0.016801933  0.0090649986}
\CommentTok{\#\textgreater{}                 CIUpper}
\CommentTok{\#\textgreater{} trt1{-}trt2  0.0280225014}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.0684475014}
\CommentTok{\#\textgreater{} trt1{-}trt4  0.0277100014}
\CommentTok{\#\textgreater{} trt1{-}trt5  0.0698975014}
\CommentTok{\#\textgreater{} trt2{-}trt3  0.0735475014}
\CommentTok{\#\textgreater{} trt2{-}trt4  0.0328100014}
\CommentTok{\#\textgreater{} trt2{-}trt5  0.0749975014}
\CommentTok{\#\textgreater{} trt3{-}trt4 {-}0.0076149986}
\CommentTok{\#\textgreater{} trt3{-}trt5  0.0345725014}
\CommentTok{\#\textgreater{} trt4{-}trt5  0.0753100014}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $RRFC$ciAvgRdrEachTrt}
\CommentTok{\#\textgreater{}       Estimate      StdErr DF    CILower    CIUpper}
\CommentTok{\#\textgreater{} Trt1 0.8451625 0.024607522  3 0.76685038 0.92347462}
\CommentTok{\#\textgreater{} Trt2 0.8502625 0.011429811  3 0.81388774 0.88663726}
\CommentTok{\#\textgreater{} Trt3 0.8098375 0.021532479  3 0.74131154 0.87836346}
\CommentTok{\#\textgreater{} Trt4 0.8505750 0.025385876  3 0.76978581 0.93136419}
\CommentTok{\#\textgreater{} Trt5 0.8083875 0.021011667  3 0.74151900 0.87525600}
\end{Highlighting}
\end{Shaded}
...
\section{Using RJafroc: dataset04, FROC analysis}\label{ORApplications-dataset04-FROC-RJafroc}}
...
\KeywordTok{print}\NormalTok{(st3)}
\CommentTok{\#\textgreater{} $FOMs}
\CommentTok{\#\textgreater{} $FOMs$foms}
\CommentTok{\#\textgreater{}            rdr1       rdr3       rdr4       rdr5}
\CommentTok{\#\textgreater{} trt1 0.77926667 0.72489167 0.70362500 0.80509167}
\CommentTok{\#\textgreater{} trt2 0.78700000 0.72690000 0.72261667 0.80378333}
\CommentTok{\#\textgreater{} trt3 0.72969167 0.71575833 0.67230833 0.77265833}
\CommentTok{\#\textgreater{} trt4 0.81013333 0.74311667 0.69435833 0.82940833}
\CommentTok{\#\textgreater{} trt5 0.74880000 0.68227500 0.65517500 0.77125000}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $FOMs$trtMeans}
\CommentTok{\#\textgreater{}        Estimate}
\CommentTok{\#\textgreater{} trt1 0.75321875}
\CommentTok{\#\textgreater{} trt2 0.76007500}
\CommentTok{\#\textgreater{} trt3 0.72260417}
\CommentTok{\#\textgreater{} trt4 0.76925417}
\CommentTok{\#\textgreater{} trt5 0.71437500}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $FOMs$trtMeanDiffs}
\CommentTok{\#\textgreater{}                Estimate}
\CommentTok{\#\textgreater{} trt1{-}trt2 {-}0.0068562500}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.0306145833}
\CommentTok{\#\textgreater{} trt1{-}trt4 {-}0.0160354167}
\CommentTok{\#\textgreater{} trt1{-}trt5  0.0388437500}
\CommentTok{\#\textgreater{} trt2{-}trt3  0.0374708333}
\CommentTok{\#\textgreater{} trt2{-}trt4 {-}0.0091791667}
\CommentTok{\#\textgreater{} trt2{-}trt5  0.0457000000}
\CommentTok{\#\textgreater{} trt3{-}trt4 {-}0.0466500000}
\CommentTok{\#\textgreater{} trt3{-}trt5  0.0082291667}
\CommentTok{\#\textgreater{} trt4{-}trt5  0.0548791667}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $ANOVA}
\CommentTok{\#\textgreater{} $ANOVA$TRanova}
\CommentTok{\#\textgreater{}              SS DF            MS}
\CommentTok{\#\textgreater{} T  0.0092661660  4 0.00231654149}
\CommentTok{\#\textgreater{} R  0.0354043662  3 0.01180145539}
\CommentTok{\#\textgreater{} TR 0.0020352419 12 0.00016960349}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $ANOVA$VarCom}
\CommentTok{\#\textgreater{}            Estimates       Rhos}
\CommentTok{\#\textgreater{} VarR   0.00220864564         NA}
\CommentTok{\#\textgreater{} VarTR {-}0.00030459978         NA}
\CommentTok{\#\textgreater{} Cov1   0.00042203598 0.45473916}
\CommentTok{\#\textgreater{} Cov2   0.00033615564 0.36220403}
\CommentTok{\#\textgreater{} Cov3   0.00030431124 0.32789204}
\CommentTok{\#\textgreater{} Var    0.00092808365         NA}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $ANOVA$IndividualTrt}
\CommentTok{\#\textgreater{}      DF   msREachTrt    varEachTrt   cov2EachTrt}
\CommentTok{\#\textgreater{} trt1  3 0.0022104190 0.00087740343 0.00033319886}
\CommentTok{\#\textgreater{} trt2  3 0.0017130271 0.00093887326 0.00038023350}
\CommentTok{\#\textgreater{} trt3  3 0.0017107295 0.00096971478 0.00029724350}
\CommentTok{\#\textgreater{} trt4  3 0.0038607283 0.00085902596 0.00031071226}
\CommentTok{\#\textgreater{} trt5  3 0.0029849654 0.00099540083 0.00035939006}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $ANOVA$IndividualRdr}
\CommentTok{\#\textgreater{}      DF    msTEachRdr    varEachRdr   cov1EachRdr}
\CommentTok{\#\textgreater{} rdr1  4 0.00101374290 0.00088314868 0.00041224847}
\CommentTok{\#\textgreater{} rdr3  4 0.00050928051 0.00089655670 0.00043556997}
\CommentTok{\#\textgreater{} rdr4  4 0.00069838090 0.00117090526 0.00049516987}
\CommentTok{\#\textgreater{} rdr5  4 0.00060394766 0.00076172396 0.00034515562}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $RRRC}
\CommentTok{\#\textgreater{} $RRRC$FTests}
\CommentTok{\#\textgreater{}                  DF            MS     FStat           p}
\CommentTok{\#\textgreater{} Treatment  4.000000 0.00231654149 7.8002997 0.000117105}
\CommentTok{\#\textgreater{} Error     36.793343 0.00029698109        NA          NA}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $RRRC$ciDiffTrt}
\CommentTok{\#\textgreater{}                Estimate     StdErr        DF           t         PrGTt}
\CommentTok{\#\textgreater{} trt1{-}trt2 {-}0.0068562500 0.01218567 36.793343 {-}0.56264860 5.7708666e{-}01}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.0306145833 0.01218567 36.793343  2.51234312 1.6509287e{-}02}
\CommentTok{\#\textgreater{} trt1{-}trt4 {-}0.0160354167 0.01218567 36.793343 {-}1.31592413 1.9633987e{-}01}
\CommentTok{\#\textgreater{} trt1{-}trt5  0.0388437500 0.01218567 36.793343  3.18765822 2.9246461e{-}03}
\CommentTok{\#\textgreater{} trt2{-}trt3  0.0374708333 0.01218567 36.793343  3.07499173 3.9557451e{-}03}
\CommentTok{\#\textgreater{} trt2{-}trt4 {-}0.0091791667 0.01218567 36.793343 {-}0.75327552 4.5607767e{-}01}
\CommentTok{\#\textgreater{} trt2{-}trt5  0.0457000000 0.01218567 36.793343  3.75030682 6.0697106e{-}04}
\CommentTok{\#\textgreater{} trt3{-}trt4 {-}0.0466500000 0.01218567 36.793343 {-}3.82826725 4.8459540e{-}04}
\CommentTok{\#\textgreater{} trt3{-}trt5  0.0082291667 0.01218567 36.793343  0.67531510 5.0369787e{-}01}
\CommentTok{\#\textgreater{} trt4{-}trt5  0.0548791667 0.01218567 36.793343  4.50358235 6.5228142e{-}05}
\CommentTok{\#\textgreater{}                 CILower       CIUpper}
\CommentTok{\#\textgreater{} trt1{-}trt2 {-}0.0315514439  0.0178389439}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.0059193894  0.0553097773}
\CommentTok{\#\textgreater{} trt1{-}trt4 {-}0.0407306106  0.0086597773}
\CommentTok{\#\textgreater{} trt1{-}trt5  0.0141485561  0.0635389439}
\CommentTok{\#\textgreater{} trt2{-}trt3  0.0127756394  0.0621660273}
\CommentTok{\#\textgreater{} trt2{-}trt4 {-}0.0338743606  0.0155160273}
\CommentTok{\#\textgreater{} trt2{-}trt5  0.0210048061  0.0703951939}
\CommentTok{\#\textgreater{} trt3{-}trt4 {-}0.0713451939 {-}0.0219548061}
\CommentTok{\#\textgreater{} trt3{-}trt5 {-}0.0164660273  0.0329243606}
\CommentTok{\#\textgreater{} trt4{-}trt5  0.0301839727  0.0795743606}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $RRRC$ciAvgRdrEachTrt}
\CommentTok{\#\textgreater{}        Estimate      StdErr         DF    CILower    CIUpper          Cov2}
\CommentTok{\#\textgreater{} trt1 0.75321875 0.029762453  7.7084474 0.68413193 0.82230557 0.00033319886}
\CommentTok{\#\textgreater{} trt2 0.76007500 0.028433963 10.6920840 0.69727167 0.82287833 0.00038023350}
\CommentTok{\#\textgreater{} trt3 0.72260417 0.026924448  8.6191761 0.66128414 0.78392420 0.00029724350}
\CommentTok{\#\textgreater{} trt4 0.76925417 0.035719663  5.2424244 0.67869638 0.85981195 0.00031071226}
\CommentTok{\#\textgreater{} trt5 0.71437500 0.033251036  6.5854184 0.63473415 0.79401585 0.00035939006}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $FRRC}
\CommentTok{\#\textgreater{} $FRRC$FTests}
\CommentTok{\#\textgreater{}                      MS     Chisq DF            p}
\CommentTok{\#\textgreater{} Treatment 0.00231654149 15.403026  4 0.0039343238}
\CommentTok{\#\textgreater{} Error     0.00060158087        NA NA           NA}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $FRRC$ciDiffTrt}
\CommentTok{\#\textgreater{}                Estimate      StdErr           z        PrGTz       CILower}
\CommentTok{\#\textgreater{} trt1{-}trt2 {-}0.0068562500 0.017343311 {-}0.39532532 0.6926028123 {-}0.0408485147}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.0306145833 0.017343311  1.76520986 0.0775285026 {-}0.0033776814}
\CommentTok{\#\textgreater{} trt1{-}trt4 {-}0.0160354167 0.017343311 {-}0.92458797 0.3551802713 {-}0.0500276814}
\CommentTok{\#\textgreater{} trt1{-}trt5  0.0388437500 0.017343311  2.23969634 0.0251106431  0.0048514853}
\CommentTok{\#\textgreater{} trt2{-}trt3  0.0374708333 0.017343311  2.16053518 0.0307312632  0.0034785686}
\CommentTok{\#\textgreater{} trt2{-}trt4 {-}0.0091791667 0.017343311 {-}0.52926265 0.5966232621 {-}0.0431714314}
\CommentTok{\#\textgreater{} trt2{-}trt5  0.0457000000 0.017343311  2.63502167 0.0084131912  0.0117077353}
\CommentTok{\#\textgreater{} trt3{-}trt4 {-}0.0466500000 0.017343311 {-}2.68979783 0.0071495318 {-}0.0806422647}
\CommentTok{\#\textgreater{} trt3{-}trt5  0.0082291667 0.017343311  0.47448649 0.6351530315 {-}0.0257630981}
\CommentTok{\#\textgreater{} trt4{-}trt5  0.0548791667 0.017343311  3.16428432 0.0015546484  0.0208869019}
\CommentTok{\#\textgreater{}                CIUpper}
\CommentTok{\#\textgreater{} trt1{-}trt2  0.027136015}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.064606848}
\CommentTok{\#\textgreater{} trt1{-}trt4  0.017956848}
\CommentTok{\#\textgreater{} trt1{-}trt5  0.072836015}
\CommentTok{\#\textgreater{} trt2{-}trt3  0.071463098}
\CommentTok{\#\textgreater{} trt2{-}trt4  0.024813098}
\CommentTok{\#\textgreater{} trt2{-}trt5  0.079692265}
\CommentTok{\#\textgreater{} trt3{-}trt4 {-}0.012657735}
\CommentTok{\#\textgreater{} trt3{-}trt5  0.042221431}
\CommentTok{\#\textgreater{} trt4{-}trt5  0.088871431}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $FRRC$ciAvgRdrEachTrt}
\CommentTok{\#\textgreater{}        Estimate      StdErr  DF    CILower    CIUpper}
\CommentTok{\#\textgreater{} trt1 0.75321875 0.021662179 199 0.71076166 0.79567584}
\CommentTok{\#\textgreater{} trt2 0.76007500 0.022801172 199 0.71538552 0.80476448}
\CommentTok{\#\textgreater{} trt3 0.72260417 0.021572235 199 0.68032336 0.76488497}
\CommentTok{\#\textgreater{} trt4 0.76925417 0.021161065 199 0.72777924 0.81072909}
\CommentTok{\#\textgreater{} trt5 0.71437500 0.022768240 199 0.66975007 0.75899993}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $FRRC$ciDiffTrtEachRdr}
\CommentTok{\#\textgreater{}                      Estimate      StdErr            z        PrGTz}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt2 {-}0.0077333333 0.030688767 {-}0.251992312 0.8010470065}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt3  0.0495750000 0.030688767  1.615411921 0.1062215205}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt4 {-}0.0308666667 0.030688767 {-}1.005796899 0.3145132792}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt5  0.0304666667 0.030688767  0.992762814 0.3208255556}
\CommentTok{\#\textgreater{} rdr1::trt2{-}trt3  0.0573083333 0.030688767  1.867404232 0.0618451592}
\CommentTok{\#\textgreater{} rdr1::trt2{-}trt4 {-}0.0231333333 0.030688767 {-}0.753804588 0.4509665689}
\CommentTok{\#\textgreater{} rdr1::trt2{-}trt5  0.0382000000 0.030688767  1.244755126 0.2132217757}
\CommentTok{\#\textgreater{} rdr1::trt3{-}trt4 {-}0.0804416667 0.030688767 {-}2.621208820 0.0087618575}
\CommentTok{\#\textgreater{} rdr1::trt3{-}trt5 {-}0.0191083333 0.030688767 {-}0.622649106 0.5335151338}
\CommentTok{\#\textgreater{} rdr1::trt4{-}trt5  0.0613333333 0.030688767  1.998559713 0.0456560130}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt2 {-}0.0020083333 0.030364016 {-}0.066141888 0.9472648623}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt3  0.0091333333 0.030364016  0.300794643 0.7635710940}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt4 {-}0.0182250000 0.030364016 {-}0.600217047 0.5483615943}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt5  0.0426166667 0.030364016  1.403525367 0.1604602331}
\CommentTok{\#\textgreater{} rdr3::trt2{-}trt3  0.0111416667 0.030364016  0.366936530 0.7136663620}
\CommentTok{\#\textgreater{} rdr3::trt2{-}trt4 {-}0.0162166667 0.030364016 {-}0.534075159 0.5932895354}
\CommentTok{\#\textgreater{} rdr3::trt2{-}trt5  0.0446250000 0.030364016  1.469667254 0.1416518956}
\CommentTok{\#\textgreater{} rdr3::trt3{-}trt4 {-}0.0273583333 0.030364016 {-}0.901011689 0.3675821046}
\CommentTok{\#\textgreater{} rdr3::trt3{-}trt5  0.0334833333 0.030364016  1.102730724 0.2701441201}
\CommentTok{\#\textgreater{} rdr3::trt4{-}trt5  0.0608416667 0.030364016  2.003742413 0.0450976604}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt2 {-}0.0189916667 0.036762356 {-}0.516606359 0.6054309755}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt3  0.0313166667 0.036762356  0.851867792 0.3942874746}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt4  0.0092666667 0.036762356  0.252069448 0.8009873847}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt5  0.0484500000 0.036762356  1.317924254 0.1875290058}
\CommentTok{\#\textgreater{} rdr4::trt2{-}trt3  0.0503083333 0.036762356  1.368474152 0.1711637075}
\CommentTok{\#\textgreater{} rdr4::trt2{-}trt4  0.0282583333 0.036762356  0.768675807 0.4420857903}
\CommentTok{\#\textgreater{} rdr4::trt2{-}trt5  0.0674416667 0.036762356  1.834530613 0.0665752679}
\CommentTok{\#\textgreater{} rdr4::trt3{-}trt4 {-}0.0220500000 0.036762356 {-}0.599798344 0.5486406368}
\CommentTok{\#\textgreater{} rdr4::trt3{-}trt5  0.0171333333 0.036762356  0.466056461 0.6411750868}
\CommentTok{\#\textgreater{} rdr4::trt4{-}trt5  0.0391833333 0.036762356  1.065854806 0.2864892816}
\CommentTok{\#\textgreater{} rdr5::trt1{-}trt2  0.0013083333 0.028864107  0.045327345 0.9638463920}
\CommentTok{\#\textgreater{} rdr5::trt1{-}trt3  0.0324333333 0.028864107  1.123656212 0.2611588993}
\CommentTok{\#\textgreater{} rdr5::trt1{-}trt4 {-}0.0243166667 0.028864107 {-}0.842453450 0.3995341855}
\CommentTok{\#\textgreater{} rdr5::trt1{-}trt5  0.0338416667 0.028864107  1.172448067 0.2410172108}
\CommentTok{\#\textgreater{} rdr5::trt2{-}trt3  0.0311250000 0.028864107  1.078328867 0.2808870188}
\CommentTok{\#\textgreater{} rdr5::trt2{-}trt4 {-}0.0256250000 0.028864107 {-}0.887780794 0.3746586757}
\CommentTok{\#\textgreater{} rdr5::trt2{-}trt5  0.0325333333 0.028864107  1.127120723 0.2596914430}
\CommentTok{\#\textgreater{} rdr5::trt3{-}trt4 {-}0.0567500000 0.028864107 {-}1.966109662 0.0492859446}
\CommentTok{\#\textgreater{} rdr5::trt3{-}trt5  0.0014083333 0.028864107  0.048791855 0.9610851732}
\CommentTok{\#\textgreater{} rdr5::trt4{-}trt5  0.0581583333 0.028864107  2.014901517 0.0439149690}
\CommentTok{\#\textgreater{}                       CILower        CIUpper}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt2 {-}0.0678822113  0.05241554467}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt3 {-}0.0105738780  0.10972387800}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt4 {-}0.0910155447  0.02928221134}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt5 {-}0.0296822113  0.09061554467}
\CommentTok{\#\textgreater{} rdr1::trt2{-}trt3 {-}0.0028405447  0.11745721134}
\CommentTok{\#\textgreater{} rdr1::trt2{-}trt4 {-}0.0832822113  0.03701554467}
\CommentTok{\#\textgreater{} rdr1::trt2{-}trt5 {-}0.0219488780  0.09834887800}
\CommentTok{\#\textgreater{} rdr1::trt3{-}trt4 {-}0.1405905447 {-}0.02029278866}
\CommentTok{\#\textgreater{} rdr1::trt3{-}trt5 {-}0.0792572113  0.04104054467}
\CommentTok{\#\textgreater{} rdr1::trt4{-}trt5  0.0011844553  0.12148221134}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt2 {-}0.0615207111  0.05750404442}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt3 {-}0.0503790444  0.06864571108}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt4 {-}0.0777373778  0.04128737775}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt5 {-}0.0168957111  0.10212904442}
\CommentTok{\#\textgreater{} rdr3::trt2{-}trt3 {-}0.0483707111  0.07065404442}
\CommentTok{\#\textgreater{} rdr3::trt2{-}trt4 {-}0.0757290444  0.04329571108}
\CommentTok{\#\textgreater{} rdr3::trt2{-}trt5 {-}0.0148873778  0.10413737775}
\CommentTok{\#\textgreater{} rdr3::trt3{-}trt4 {-}0.0868707111  0.03215404442}
\CommentTok{\#\textgreater{} rdr3::trt3{-}trt5 {-}0.0260290444  0.09299571108}
\CommentTok{\#\textgreater{} rdr3::trt4{-}trt5  0.0013292889  0.12035404442}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt2 {-}0.0910445595  0.05306122620}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt3 {-}0.0407362262  0.10336955954}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt4 {-}0.0627862262  0.08131955954}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt5 {-}0.0236028929  0.12050289287}
\CommentTok{\#\textgreater{} rdr4::trt2{-}trt3 {-}0.0217445595  0.12236122620}
\CommentTok{\#\textgreater{} rdr4::trt2{-}trt4 {-}0.0437945595  0.10031122620}
\CommentTok{\#\textgreater{} rdr4::trt2{-}trt5 {-}0.0046112262  0.13949455954}
\CommentTok{\#\textgreater{} rdr4::trt3{-}trt4 {-}0.0941028929  0.05000289287}
\CommentTok{\#\textgreater{} rdr4::trt3{-}trt5 {-}0.0549195595  0.08918622620}
\CommentTok{\#\textgreater{} rdr4::trt4{-}trt5 {-}0.0328695595  0.11123622620}
\CommentTok{\#\textgreater{} rdr5::trt1{-}trt2 {-}0.0552642772  0.05788094384}
\CommentTok{\#\textgreater{} rdr5::trt1{-}trt3 {-}0.0241392772  0.08900594384}
\CommentTok{\#\textgreater{} rdr5::trt1{-}trt4 {-}0.0808892772  0.03225594384}
\CommentTok{\#\textgreater{} rdr5::trt1{-}trt5 {-}0.0227309438  0.09041427718}
\CommentTok{\#\textgreater{} rdr5::trt2{-}trt3 {-}0.0254476105  0.08769761051}
\CommentTok{\#\textgreater{} rdr5::trt2{-}trt4 {-}0.0821976105  0.03094761051}
\CommentTok{\#\textgreater{} rdr5::trt2{-}trt5 {-}0.0240392772  0.08910594384}
\CommentTok{\#\textgreater{} rdr5::trt3{-}trt4 {-}0.1133226105 {-}0.00017738949}
\CommentTok{\#\textgreater{} rdr5::trt3{-}trt5 {-}0.0551642772  0.05798094384}
\CommentTok{\#\textgreater{} rdr5::trt4{-}trt5  0.0015857228  0.11473094384}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $FRRC$IndividualRdrVarCov1}
\CommentTok{\#\textgreater{}         varEachRdr   cov1EachRdr}
\CommentTok{\#\textgreater{} rdr1 0.00088314868 0.00041224847}
\CommentTok{\#\textgreater{} rdr3 0.00089655670 0.00043556997}
\CommentTok{\#\textgreater{} rdr4 0.00117090526 0.00049516987}
\CommentTok{\#\textgreater{} rdr5 0.00076172396 0.00034515562}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $RRFC}
\CommentTok{\#\textgreater{} $RRFC$FTests}
\CommentTok{\#\textgreater{}    DF            MS         F             p}
\CommentTok{\#\textgreater{} T   4 0.00231654149 13.658572 0.00020192224}
\CommentTok{\#\textgreater{} TR 12 0.00016960349        NA            NA}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $RRFC$ciDiffTrt}
\CommentTok{\#\textgreater{}                Estimate       StdErr DF           t         PrGTt      CILower}
\CommentTok{\#\textgreater{} trt1{-}trt2 {-}0.0068562500 0.0092087864 12 {-}0.74453350 4.7088356e{-}01 {-}0.026920472}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.0306145833 0.0092087864 12  3.32449706 6.0595183e{-}03  0.010550361}
\CommentTok{\#\textgreater{} trt1{-}trt4 {-}0.0160354167 0.0092087864 12 {-}1.74131704 1.0717825e{-}01 {-}0.036099639}
\CommentTok{\#\textgreater{} trt1{-}trt5  0.0388437500 0.0092087864 12  4.21811825 1.1928824e{-}03  0.018779528}
\CommentTok{\#\textgreater{} trt2{-}trt3  0.0374708333 0.0092087864 12  4.06903056 1.5563074e{-}03  0.017406611}
\CommentTok{\#\textgreater{} trt2{-}trt4 {-}0.0091791667 0.0092087864 12 {-}0.99678353 3.3854538e{-}01 {-}0.029243389}
\CommentTok{\#\textgreater{} trt2{-}trt5  0.0457000000 0.0092087864 12  4.96265175 3.2930420e{-}04  0.025635778}
\CommentTok{\#\textgreater{} trt3{-}trt4 {-}0.0466500000 0.0092087864 12 {-}5.06581410 2.7711820e{-}04 {-}0.066714222}
\CommentTok{\#\textgreater{} trt3{-}trt5  0.0082291667 0.0092087864 12  0.89362119 3.8909518e{-}01 {-}0.011835055}
\CommentTok{\#\textgreater{} trt4{-}trt5  0.0548791667 0.0092087864 12  5.95943529 6.6167481e{-}05  0.034814945}
\CommentTok{\#\textgreater{}                 CIUpper}
\CommentTok{\#\textgreater{} trt1{-}trt2  0.0132079720}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.0506788053}
\CommentTok{\#\textgreater{} trt1{-}trt4  0.0040288053}
\CommentTok{\#\textgreater{} trt1{-}trt5  0.0589079720}
\CommentTok{\#\textgreater{} trt2{-}trt3  0.0575350553}
\CommentTok{\#\textgreater{} trt2{-}trt4  0.0108850553}
\CommentTok{\#\textgreater{} trt2{-}trt5  0.0657642220}
\CommentTok{\#\textgreater{} trt3{-}trt4 {-}0.0265857780}
\CommentTok{\#\textgreater{} trt3{-}trt5  0.0282933886}
\CommentTok{\#\textgreater{} trt4{-}trt5  0.0749433886}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $RRFC$ciAvgRdrEachTrt}
\CommentTok{\#\textgreater{}        Estimate      StdErr DF    CILower    CIUpper}
\CommentTok{\#\textgreater{} Trt1 0.75321875 0.023507547  3 0.67840724 0.82803026}
\CommentTok{\#\textgreater{} Trt2 0.76007500 0.020694366  3 0.69421629 0.82593371}
\CommentTok{\#\textgreater{} Trt3 0.72260417 0.020680483  3 0.65678964 0.78841869}
\CommentTok{\#\textgreater{} Trt4 0.76925417 0.031067379  3 0.67038390 0.86812443}
\CommentTok{\#\textgreater{} Trt5 0.71437500 0.027317419  3 0.62743878 0.80131122}
\end{Highlighting}
\end{Shaded}
...
\section{Using RJafroc for dataset04, FROC analysis, DBM method}\label{ORApplications-dataset04-FROC-DBM-RJafroc}}

\begin{itemize}
\tightlist
\item
  The fourth example again uses \texttt{dataset04}, i.e., FROC data, \emph{but this time we use DBM analysis}.
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{st4 \textless{}{-}}\StringTok{ }\KeywordTok{StSignificanceTesting}\NormalTok{(ds, }\DataTypeTok{FOM =}\NormalTok{ FOM, }\DataTypeTok{method =} \StringTok{"DBM"}\NormalTok{) }\CommentTok{\# Note: using DBM analysis}
\KeywordTok{print}\NormalTok{(st4)}
\CommentTok{\#\textgreater{} $FOMs}
\CommentTok{\#\textgreater{} $FOMs$foms}
\CommentTok{\#\textgreater{}            rdr1       rdr3       rdr4       rdr5}
\CommentTok{\#\textgreater{} trt1 0.77926667 0.72489167 0.70362500 0.80509167}
...
\CommentTok{\#\textgreater{}                 SS   DF          MS}
\CommentTok{\#\textgreater{} T       1.85323319    4 0.463308298}
\CommentTok{\#\textgreater{} R       7.08087324    3 2.360291078}
\CommentTok{\#\textgreater{} C     289.60188783  199 1.455285868}
\CommentTok{\#\textgreater{} TR      0.40704839   12 0.033920699}
\CommentTok{\#\textgreater{} TC     95.77167376  796 0.120316173}
\CommentTok{\#\textgreater{} RC    126.90154272  597 0.212565398}
\CommentTok{\#\textgreater{} TRC   226.47948201 2388 0.094840654}
\CommentTok{\#\textgreater{} Total 748.09574113 3999          NA}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $ANOVA$VarCom}
\CommentTok{\#\textgreater{}             Estimates}
\CommentTok{\#\textgreater{} VarR    0.00220864564}
\CommentTok{\#\textgreater{} VarC    0.06086224757}
\CommentTok{\#\textgreater{} VarTR  {-}0.00030459978}
\CommentTok{\#\textgreater{} VarTC   0.00636887974}
\CommentTok{\#\textgreater{} VarRC   0.02354494882}
\CommentTok{\#\textgreater{} VarErr  0.09484065411}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $ANOVA$IndividualTrt}
\CommentTok{\#\textgreater{}       DF       Trt1       Trt2       Trt3       Trt4       Trt5}
\CommentTok{\#\textgreater{} msR    3 0.44208381 0.34260543 0.34214590 0.77214565 0.59699308}
\CommentTok{\#\textgreater{} msC  199 0.37540000 0.41591475 0.37228906 0.35823255 0.41471420}
\CommentTok{\#\textgreater{} msRC 597 0.10884091 0.11172795 0.13449426 0.10966274 0.12720215}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $ANOVA$IndividualRdr}
\CommentTok{\#\textgreater{}       DF        rdr1        rdr3       rdr4        rdr5}
\CommentTok{\#\textgreater{} msT    4 0.202748581 0.101856101 0.13967618 0.120789532}
\CommentTok{\#\textgreater{} msC  199 0.506428511 0.527767315 0.63031695 0.428469287}
\CommentTok{\#\textgreater{} msTC 796 0.094180042 0.092197347 0.13514708 0.083313668}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $RRRC}
\CommentTok{\#\textgreater{} $RRRC$FTests}
\CommentTok{\#\textgreater{}                  DF          MS     FStat           p}
\CommentTok{\#\textgreater{} Treatment  4.000000 0.463308298 7.8002997 0.000117105}
\CommentTok{\#\textgreater{} Error     36.793343 0.059396218        NA          NA}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $RRRC$ciDiffTrt}
\CommentTok{\#\textgreater{}                Estimate     StdErr        DF           t         PrGTt}
\CommentTok{\#\textgreater{} trt1{-}trt2 {-}0.0068562500 0.01218567 36.793343 {-}0.56264860 5.7708666e{-}01}
...
\CommentTok{\#\textgreater{} $RRRC$ciAvgRdrEachTrt}
\CommentTok{\#\textgreater{}        Estimate      StdErr         DF    CILower    CIUpper}
\CommentTok{\#\textgreater{} trt1 0.75321875 0.029762453  7.7084474 0.68413193 0.82230557}
\CommentTok{\#\textgreater{} trt2 0.76007500 0.028433963 10.6920840 0.69727167 0.82287833}
\CommentTok{\#\textgreater{} trt3 0.72260417 0.026924448  8.6191761 0.66128414 0.78392420}
\CommentTok{\#\textgreater{} trt4 0.76925417 0.035719663  5.2424244 0.67869638 0.85981195}
\CommentTok{\#\textgreater{} trt5 0.71437500 0.033251036  6.5854184 0.63473415 0.79401585}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $FRRC}
\CommentTok{\#\textgreater{} $FRRC$FTests}
\CommentTok{\#\textgreater{}            DF         MS     FStat           p}
\CommentTok{\#\textgreater{} Treatment   4 0.46330830 3.8507566 0.004163522}
\CommentTok{\#\textgreater{} Error     796 0.12031617        NA          NA}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $FRRC$ciDiffTrt}
\CommentTok{\#\textgreater{}                Estimate      StdErr  DF           t        PrGTt       CILower}
\CommentTok{\#\textgreater{} trt1{-}trt2 {-}0.0068562500 0.017343311 796 {-}0.39532532 0.6927087308 {-}0.0409002793}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.0306145833 0.017343311 796  1.76520986 0.0779118871 {-}0.0034294460}
\CommentTok{\#\textgreater{} trt1{-}trt4 {-}0.0160354167 0.017343311 796 {-}0.92458797 0.3554604706 {-}0.0500794460}
\CommentTok{\#\textgreater{} trt1{-}trt5  0.0388437500 0.017343311 796  2.23969634 0.0253859867  0.0047997207}
\CommentTok{\#\textgreater{} trt2{-}trt3  0.0374708333 0.017343311 796  2.16053518 0.0310289993  0.0034268040}
\CommentTok{\#\textgreater{} trt2{-}trt4 {-}0.0091791667 0.017343311 796 {-}0.52926265 0.5967708242 {-}0.0432231960}
\CommentTok{\#\textgreater{} trt2{-}trt5  0.0457000000 0.017343311 796  2.63502167 0.0085768050  0.0116559707}
\CommentTok{\#\textgreater{} trt3{-}trt4 {-}0.0466500000 0.017343311 796 {-}2.68979783 0.0072992573 {-}0.0806940293}
\CommentTok{\#\textgreater{} trt3{-}trt5  0.0082291667 0.017343311 796  0.47448649 0.6352831698 {-}0.0258148626}
\CommentTok{\#\textgreater{} trt4{-}trt5  0.0548791667 0.017343311 796  3.16428432 0.0016137424  0.0208351374}
\CommentTok{\#\textgreater{}                CIUpper}
\CommentTok{\#\textgreater{} trt1{-}trt2  0.027187779}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.064658613}
\CommentTok{\#\textgreater{} trt1{-}trt4  0.018008613}
\CommentTok{\#\textgreater{} trt1{-}trt5  0.072887779}
\CommentTok{\#\textgreater{} trt2{-}trt3  0.071514863}
\CommentTok{\#\textgreater{} trt2{-}trt4  0.024864863}
\CommentTok{\#\textgreater{} trt2{-}trt5  0.079744029}
\CommentTok{\#\textgreater{} trt3{-}trt4 {-}0.012605971}
\CommentTok{\#\textgreater{} trt3{-}trt5  0.042273196}
\CommentTok{\#\textgreater{} trt4{-}trt5  0.088923196}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $FRRC$ciAvgRdrEachTrt}
\CommentTok{\#\textgreater{}        Estimate      StdErr  DF    CILower    CIUpper}
\CommentTok{\#\textgreater{} trt1 0.75321875 0.021662179 199 0.71050187 0.79593563}
\CommentTok{\#\textgreater{} trt2 0.76007500 0.022801172 199 0.71511208 0.80503792}
\CommentTok{\#\textgreater{} trt3 0.72260417 0.021572235 199 0.68006466 0.76514368}
\CommentTok{\#\textgreater{} trt4 0.76925417 0.021161065 199 0.72752547 0.81098287}
\CommentTok{\#\textgreater{} trt5 0.71437500 0.022768240 199 0.66947702 0.75927298}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $FRRC$ciDiffTrtEachRdr}
\CommentTok{\#\textgreater{}                      Estimate      StdErr  DF            t        PrGTt}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt2 {-}0.0077333333 0.030688767 199 {-}0.251992312 0.8013070675}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt3  0.0495750000 0.030688767 199  1.615411921 0.1078058305}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt4 {-}0.0308666667 0.030688767 199 {-}1.005796899 0.3157346970}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt5  0.0304666667 0.030688767 199  0.992762814 0.3220311471}
\CommentTok{\#\textgreater{} rdr1::trt2{-}trt3  0.0573083333 0.030688767 199  1.867404232 0.0633155472}
\CommentTok{\#\textgreater{} rdr1::trt2{-}trt4 {-}0.0231333333 0.030688767 199 {-}0.753804588 0.4518575457}
\CommentTok{\#\textgreater{} rdr1::trt2{-}trt5  0.0382000000 0.030688767 199  1.244755126 0.2146856872}
\CommentTok{\#\textgreater{} rdr1::trt3{-}trt4 {-}0.0804416667 0.030688767 199 {-}2.621208820 0.0094386515}
\CommentTok{\#\textgreater{} rdr1::trt3{-}trt5 {-}0.0191083333 0.030688767 199 {-}0.622649106 0.5342279782}
\CommentTok{\#\textgreater{} rdr1::trt4{-}trt5  0.0613333333 0.030688767 199  1.998559713 0.0470170958}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt2 {-}0.0020083333 0.030364016 199 {-}0.066141888 0.9473312632}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt3  0.0091333333 0.030364016 199  0.300794643 0.7638851251}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt4 {-}0.0182250000 0.030364016 199 {-}0.600217047 0.5490444896}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt5  0.0426166667 0.030364016 199  1.403525367 0.1620187360}
\CommentTok{\#\textgreater{} rdr3::trt2{-}trt3  0.0111416667 0.030364016 199  0.366936530 0.7140562449}
\CommentTok{\#\textgreater{} rdr3::trt2{-}trt4 {-}0.0162166667 0.030364016 199 {-}0.534075159 0.5938856422}
\CommentTok{\#\textgreater{} rdr3::trt2{-}trt5  0.0446250000 0.030364016 199  1.469667254 0.1432310786}
\CommentTok{\#\textgreater{} rdr3::trt3{-}trt4 {-}0.0273583333 0.030364016 199 {-}0.901011689 0.3686712399}
\CommentTok{\#\textgreater{} rdr3::trt3{-}trt5  0.0334833333 0.030364016 199  1.102730724 0.2714759176}
\CommentTok{\#\textgreater{} rdr3::trt4{-}trt5  0.0608416667 0.030364016 199  2.003742413 0.0464538856}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt2 {-}0.0189916667 0.036762356 199 {-}0.516606359 0.6060045976}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt3  0.0313166667 0.036762356 199  0.851867792 0.3953114650}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt4  0.0092666667 0.036762356 199  0.252069448 0.8012475297}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt5  0.0484500000 0.036762356 199  1.317924254 0.1890441132}
\CommentTok{\#\textgreater{} rdr4::trt2{-}trt3  0.0503083333 0.036762356 199  1.368474152 0.1727066684}
\CommentTok{\#\textgreater{} rdr4::trt2{-}trt4  0.0282583333 0.036762356 199  0.768675807 0.4429970724}
\CommentTok{\#\textgreater{} rdr4::trt2{-}trt5  0.0674416667 0.036762356 199  1.834530613 0.0680683497}
\CommentTok{\#\textgreater{} rdr4::trt3{-}trt4 {-}0.0220500000 0.036762356 199 {-}0.599798344 0.5493229753}
\CommentTok{\#\textgreater{} rdr4::trt3{-}trt5  0.0171333333 0.036762356 199  0.466056461 0.6416848108}
\CommentTok{\#\textgreater{} rdr4::trt4{-}trt5  0.0391833333 0.036762356 199  1.065854806 0.2877807352}
\CommentTok{\#\textgreater{} rdr5::trt1{-}trt2  0.0013083333 0.028864107 199  0.045327345 0.9638918444}
\CommentTok{\#\textgreater{} rdr5::trt1{-}trt3  0.0324333333 0.028864107 199  1.123656212 0.2625125832}
\CommentTok{\#\textgreater{} rdr5::trt1{-}trt4 {-}0.0243166667 0.028864107 199 {-}0.842453450 0.4005455428}
\CommentTok{\#\textgreater{} rdr5::trt1{-}trt5  0.0338416667 0.028864107 199  1.172448067 0.2424188377}
\CommentTok{\#\textgreater{} rdr5::trt2{-}trt3  0.0311250000 0.028864107 199  1.078328867 0.2821923628}
\CommentTok{\#\textgreater{} rdr5::trt2{-}trt4 {-}0.0256250000 0.028864107 199 {-}0.887780794 0.3757304216}
\CommentTok{\#\textgreater{} rdr5::trt2{-}trt5  0.0325333333 0.028864107 199  1.127120723 0.2610486764}
\CommentTok{\#\textgreater{} rdr5::trt3{-}trt4 {-}0.0567500000 0.028864107 199 {-}1.966109662 0.0506765926}
\CommentTok{\#\textgreater{} rdr5::trt3{-}trt5  0.0014083333 0.028864107 199  0.048791855 0.9611341077}
\CommentTok{\#\textgreater{} rdr5::trt4{-}trt5  0.0581583333 0.028864107 199  2.014901517 0.0452606144}
\CommentTok{\#\textgreater{}                        CILower        CIUpper}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt2 {-}0.06825024821  0.05278358154}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt3 {-}0.01094191487  0.11009191487}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt4 {-}0.09138358154  0.02965024821}
\CommentTok{\#\textgreater{} rdr1::trt1{-}trt5 {-}0.03005024821  0.09098358154}
\CommentTok{\#\textgreater{} rdr1::trt2{-}trt3 {-}0.00320858154  0.11782524821}
\CommentTok{\#\textgreater{} rdr1::trt2{-}trt4 {-}0.08365024821  0.03738358154}
\CommentTok{\#\textgreater{} rdr1::trt2{-}trt5 {-}0.02231691487  0.09871691487}
\CommentTok{\#\textgreater{} rdr1::trt3{-}trt4 {-}0.14095858154 {-}0.01992475179}
\CommentTok{\#\textgreater{} rdr1::trt3{-}trt5 {-}0.07962524821  0.04140858154}
\CommentTok{\#\textgreater{} rdr1::trt4{-}trt5  0.00081641846  0.12185024821}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt2 {-}0.06188485336  0.05786818669}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt3 {-}0.05074318669  0.06900985336}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt4 {-}0.07810152003  0.04165152003}
\CommentTok{\#\textgreater{} rdr3::trt1{-}trt5 {-}0.01725985336  0.10249318669}
\CommentTok{\#\textgreater{} rdr3::trt2{-}trt3 {-}0.04873485336  0.07101818669}
\CommentTok{\#\textgreater{} rdr3::trt2{-}trt4 {-}0.07609318669  0.04365985336}
\CommentTok{\#\textgreater{} rdr3::trt2{-}trt5 {-}0.01525152003  0.10450152003}
\CommentTok{\#\textgreater{} rdr3::trt3{-}trt4 {-}0.08723485336  0.03251818669}
\CommentTok{\#\textgreater{} rdr3::trt3{-}trt5 {-}0.02639318669  0.09335985336}
\CommentTok{\#\textgreater{} rdr3::trt4{-}trt5  0.00096514664  0.12071818669}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt2 {-}0.09148543428  0.05350210095}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt3 {-}0.04117710095  0.10381043428}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt4 {-}0.06322710095  0.08176043428}
\CommentTok{\#\textgreater{} rdr4::trt1{-}trt5 {-}0.02404376761  0.12094376761}
\CommentTok{\#\textgreater{} rdr4::trt2{-}trt3 {-}0.02218543428  0.12280210095}
\CommentTok{\#\textgreater{} rdr4::trt2{-}trt4 {-}0.04423543428  0.10075210095}
\CommentTok{\#\textgreater{} rdr4::trt2{-}trt5 {-}0.00505210095  0.13993543428}
\CommentTok{\#\textgreater{} rdr4::trt3{-}trt4 {-}0.09454376761  0.05044376761}
\CommentTok{\#\textgreater{} rdr4::trt3{-}trt5 {-}0.05536043428  0.08962710095}
\CommentTok{\#\textgreater{} rdr4::trt4{-}trt5 {-}0.03331043428  0.11167710095}
\CommentTok{\#\textgreater{} rdr5::trt1{-}trt2 {-}0.05561043170  0.05822709837}
\CommentTok{\#\textgreater{} rdr5::trt1{-}trt3 {-}0.02448543170  0.08935209837}
\CommentTok{\#\textgreater{} rdr5::trt1{-}trt4 {-}0.08123543170  0.03260209837}
\CommentTok{\#\textgreater{} rdr5::trt1{-}trt5 {-}0.02307709837  0.09076043170}
\CommentTok{\#\textgreater{} rdr5::trt2{-}trt3 {-}0.02579376504  0.08804376504}
\CommentTok{\#\textgreater{} rdr5::trt2{-}trt4 {-}0.08254376504  0.03129376504}
\CommentTok{\#\textgreater{} rdr5::trt2{-}trt5 {-}0.02438543170  0.08945209837}
\CommentTok{\#\textgreater{} rdr5::trt3{-}trt4 {-}0.11366876504  0.00016876504}
\CommentTok{\#\textgreater{} rdr5::trt3{-}trt5 {-}0.05551043170  0.05832709837}
\CommentTok{\#\textgreater{} rdr5::trt4{-}trt5  0.00123956830  0.11507709837}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $RRFC}
\CommentTok{\#\textgreater{} $RRFC$FTests}
\CommentTok{\#\textgreater{}           DF          MS     FStat             p}
\CommentTok{\#\textgreater{} Treatment  4 0.463308298 13.658572 0.00020192224}
\CommentTok{\#\textgreater{} Error     12 0.033920699        NA            NA}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $RRFC$ciDiffTrt}
\CommentTok{\#\textgreater{}                Estimate       StdErr DF           t         PrGTt      CILower}
\CommentTok{\#\textgreater{} trt1{-}trt2 {-}0.0068562500 0.0092087864 12 {-}0.74453350 4.7088356e{-}01 {-}0.026920472}
...
\section{Tentative, need to think over}\label{ToMullOver1-tentative}}
...
\KeywordTok{print}\NormalTok{(st5)}
\CommentTok{\#\textgreater{} $FOMs}
\CommentTok{\#\textgreater{} $FOMs$foms}
\CommentTok{\#\textgreater{}            rdr1       rdr3       rdr4       rdr5}
\CommentTok{\#\textgreater{} trt1 0.77926667 0.72489167 0.70362500 0.80509167}
