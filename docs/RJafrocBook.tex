...
\CommentTok{\#\textgreater{} 1    1.3219774          1   0.25023748}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{ORApplications-steps}{%
\section{Steps in the analysis}\label{ORApplications-steps}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{vc \textless{}{-}}\StringTok{ }\KeywordTok{UtilORVarComponentsFactorial}\NormalTok{(dataset02, }\DataTypeTok{FOM =} \StringTok{"Wilcoxon"}\NormalTok{, }\DataTypeTok{covEstMethod =} \StringTok{"jackknife"}\NormalTok{)}
...
\KeywordTok{print}\NormalTok{(vc}\OperatorTok{$}\NormalTok{IndividualTrt)}
...
\KeywordTok{print}\NormalTok{(vc}\OperatorTok{$}\NormalTok{IndividualRdr)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{den \textless{}{-}}\StringTok{ }\NormalTok{vc}\OperatorTok{$}\NormalTok{TRanova[}\StringTok{"TR"}\NormalTok{, }\StringTok{"MS"}\NormalTok{] }\OperatorTok{+}\StringTok{ }\NormalTok{J}\OperatorTok{*}\StringTok{ }\KeywordTok{max}\NormalTok{(vc}\OperatorTok{$}\NormalTok{VarCom[}\StringTok{"Cov2"}\NormalTok{, }\StringTok{"Estimates"}\NormalTok{] }\OperatorTok{{-}}\StringTok{ }\NormalTok{vc}\OperatorTok{$}\NormalTok{VarCom[}\StringTok{"Cov3"}\NormalTok{, }\StringTok{"Estimates"}\NormalTok{],}\DecValTok{0}\NormalTok{)}
...
\tightlist
\item
  From the previous chapter, the \((1-\alpha)\) confidence interval for \(\theta_{1 \bullet} - \theta_{2 \bullet}\) is given by Eqn. \eqref{eq:CI-DiffFomRRRC}.
\item
