...
\CommentTok{\#\textgreater{} 1    1.4016463          1   0.23644812}
\end{Highlighting}
\end{Shaded}
...
\item
  The \((1-\alpha)\) confidence interval the difference is given by Eqn. \eqref{eq:CI-diffFomRRRC}.
\item
...
\NormalTok{CI\_RRRC \textless{}{-}}\StringTok{ }\KeywordTok{array}\NormalTok{(}\DataTypeTok{dim =} \KeywordTok{c}\NormalTok{(}\KeywordTok{length}\NormalTok{(trtMeanDiffs), }\DecValTok{2}\NormalTok{))}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(trtMeanDiffs)) \{}
\NormalTok{  tStat[i] \textless{}{-}}\StringTok{ }\NormalTok{trtMeanDiffs[i]}\OperatorTok{/}\NormalTok{stdErr}
\NormalTok{  PrGTt[i] \textless{}{-}}\StringTok{ }\DecValTok{2}\OperatorTok{*}\KeywordTok{pt}\NormalTok{(}\KeywordTok{abs}\NormalTok{(tStat[i]), ddf, }\DataTypeTok{lower.tail =} \OtherTok{FALSE}\NormalTok{)}
\NormalTok{  CI\_RRRC[i, ] \textless{}{-}}\StringTok{ }\KeywordTok{sort}\NormalTok{(}\KeywordTok{c}\NormalTok{(trtMeanDiffs[i] }\OperatorTok{{-}}\StringTok{ }\KeywordTok{qt}\NormalTok{(alpha}\OperatorTok{/}\DecValTok{2}\NormalTok{, ddf) }\OperatorTok{*}\StringTok{ }\NormalTok{stdErr, trtMeanDiffs[i] }\OperatorTok{+}\StringTok{ }\KeywordTok{qt}\NormalTok{(alpha}\OperatorTok{/}\DecValTok{2}\NormalTok{, ddf) }\OperatorTok{*}\StringTok{ }\NormalTok{stdErr))}
\NormalTok{\}}
\KeywordTok{print}\NormalTok{(CI\_RRRC)}
\CommentTok{\#\textgreater{}            [,1]         [,2]}
\CommentTok{\#\textgreater{} [1,] {-}0.0879595 0.0003588544}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{CI\_FRRC \textless{}{-}}\StringTok{ }\KeywordTok{array}\NormalTok{(}\DataTypeTok{dim =} \KeywordTok{c}\NormalTok{(}\KeywordTok{choose}\NormalTok{(I,}\DecValTok{2}\NormalTok{),}\DecValTok{2}\NormalTok{))}
...
\NormalTok{  CI\_FRRC[i, ] \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(trtMeanDiffs[i] }\OperatorTok{+}\StringTok{ }\KeywordTok{qnorm}\NormalTok{(alpha}\OperatorTok{/}\DecValTok{2}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{stdErr, }
...
\CommentTok{\#\textgreater{}             [,1]        [,2]}
\CommentTok{\#\textgreater{} [1,] {-}0.08048591 {-}0.00711473}
\end{Highlighting}
\end{Shaded}
