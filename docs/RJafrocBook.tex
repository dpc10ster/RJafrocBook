...
\KeywordTok{cat}\NormalTok{(}\StringTok{"Exact 95\% CI on Specificity = "}\NormalTok{, }
...
\KeywordTok{cat}\NormalTok{(}\StringTok{"Exact 95\% CI on Sensitivity = "}\NormalTok{, }
    \KeywordTok{as.numeric}\NormalTok{(ret}\OperatorTok{$}\NormalTok{conf.int),}\StringTok{"}\CharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
...
\CommentTok{\#\textgreater{} 1    1.1453594          1    0.2845227}
\end{Highlighting}
\end{Shaded}
