...
\tightlist
\item
  The purpose of this vignette is to explain the data format of the input Excel file and to introduce the capabilities of the function \texttt{DfReadDataFile()}. Background on observer performance methods are in my book.
\item
...
\caption{Fig. 1 Truth worksheet for file rocCr.xlsx}\label{fig:unnamed-chunk-1}
\end{figure}
...
\caption{Fig. 1 FP worksheet for file rocCr.xlsx}\label{fig:unnamed-chunk-3}
\end{figure}
...
\caption{Fig. 1 TP worksheet for file rocCr.xlsx}\label{fig:unnamed-chunk-4}
\end{figure}
...
\tightlist
\item
  In the Free-response Receiver Operating Characteristic (FROC) paradigm the observer searches each case for signs of \textbf{localized disease} and marks and rates localized regions that are sufficiently suspicious for disease presence.
\item
...
\caption{Fig. 1: Truth worksheet for file inst/extdata/toyFiles/FROC/frocCr.xlsx}\label{fig:unnamed-chunk-1}
\end{figure}
...
\caption{Fig. 2: FP/NL worksheet for file inst/extdata/toyFiles/FROC/frocCr.xlsx}\label{fig:unnamed-chunk-5}
\end{figure}
...
\caption{Fig. 3: TP/LL worksheet for file inst/extdata/toyFiles/FROC/frocCr.xlsx}\label{fig:unnamed-chunk-6}
\end{figure}
