...
\item
  ...
  \tightlist
  \item
    indicate (i.e., \textbf{mark} the location of) and
  \item
...
Such a dataset \citep{RN1882} is included as \texttt{dataset04}. It has the following structure:
...
\tightlist
\item
  The \texttt{lesionNum} list member is an array of length 100, filled with integers ranging from 1 to the maximum number of actul lesions (per case) in the dataset. The length of this array equals the number of diseased cases \texttt{K2}, 100 in the current example. For this dataset, the contents of \texttt{lesionNum} are shown below:
\end{itemize}
...
\item
  The lesion on case 1 is \textbf{labeled} by the value 1. The \texttt{-Inf} denote missing values. Since there is only one lesion, the placeholders for possible 2 or 3 lesions (not present on this case, but needed to hold lesion labels in other cases) need to be filled with negative infinites.
\item
...
\item
  The key point is this: each lesion on a case has a \emph{name}. The names are used in the data file creation process.
\item
...
\item
  As we saw for ROC data, the \texttt{TP/LL} worksheet has a \texttt{lesionID} column. Since the ROC paradigm does not allow multiple lesions per case, each diseased case conceptually containing one lesion, so the question of distinct lesion names of the same diseased case does not arise.
\item
  At least one investigator made the mistake of assuming the lesion name, i.e., the \texttt{lesionID} field had no meaning, and randomly assigned the rating to the lesions.
\end{itemize}
...
\tightlist
\item
  The \texttt{LesionWeight} list member is also a \texttt{{[}100\ x\ 3{]}} array filled with values that add up to unity for each case.
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dataset04}\OperatorTok{$}\NormalTok{lesionWeight}
\CommentTok{#>             [,1]      [,2]      [,3]}
\CommentTok{#>   [1,] 1.0000000      -Inf      -Inf}
\CommentTok{#>   [2,] 1.0000000      -Inf      -Inf}
\CommentTok{#>   [3,] 1.0000000      -Inf      -Inf}
\CommentTok{#>   [4,] 1.0000000      -Inf      -Inf}
\CommentTok{#>   [5,] 1.0000000      -Inf      -Inf}
\CommentTok{#>   [6,] 1.0000000      -Inf      -Inf}
\CommentTok{#>   [7,] 1.0000000      -Inf      -Inf}
\CommentTok{#>   [8,] 1.0000000      -Inf      -Inf}
\CommentTok{#>   [9,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [10,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [11,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [12,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [13,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [14,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [15,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [16,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [17,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [18,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [19,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [20,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [21,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [22,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [23,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [24,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [25,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [26,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [27,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [28,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [29,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [30,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [31,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [32,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [33,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [34,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [35,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [36,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [37,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [38,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [39,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [40,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [41,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [42,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [43,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [44,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [45,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [46,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [47,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [48,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [49,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [50,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [51,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [52,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [53,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [54,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [55,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [56,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [57,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [58,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [59,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [60,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [61,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [62,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [63,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [64,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [65,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [66,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [67,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [68,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [69,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [70,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [71,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [72,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [73,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [74,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [75,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [76,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [77,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [78,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [79,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [80,] 1.0000000      -Inf      -Inf}
\CommentTok{#>  [81,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [82,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [83,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [84,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [85,] 0.3333333 0.3333333 0.3333333}
\CommentTok{#>  [86,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [87,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [88,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [89,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [90,] 0.5000000 0.5000000      -Inf}
\CommentTok{#>  [91,] 0.3333333 0.3333333 0.3333333}
\CommentTok{#>  [92,] 0.3333333 0.3333333 0.3333333}
\CommentTok{#>  [93,] 0.3333333 0.3333333 0.3333333}
\CommentTok{#>  [94,] 0.3333333 0.3333333 0.3333333}
\CommentTok{#>  [95,] 0.3333333 0.3333333 0.3333333}
\CommentTok{#>  [96,] 0.3333333 0.3333333 0.3333333}
\CommentTok{#>  [97,] 0.3333333 0.3333333 0.3333333}
\CommentTok{#>  [98,] 0.3333333 0.3333333 0.3333333}
\CommentTok{#>  [99,] 0.3333333 0.3333333 0.3333333}
\CommentTok{#> [100,] 0.3333333 0.3333333 0.3333333}
\end{Highlighting}
\end{Shaded}
...
\item
  Location-level ratings of non-diseased regions are stored in the \texttt{NL} list member of the dataset.
\item
  Location-level ratings of diseased regions are stored in the \texttt{LL} list member of the dataset.
\end{itemize}
...
\subsubsection{The FP/NL worksheet organization}\label{the-fpnl-worksheet-organization-1}}

\hypertarget{the-tpll-worksheet-organization-1}{%
\subsubsection{The TP/LL worksheet organization}\label{the-tpll-worksheet-organization-1}}
