...
The likelihood function is the product of Eqn. \eqref{eq:BinormalModelProduct} and Eqn. \eqref{eq:BinormalModelCombFactor}:
...
\CommentTok{\#\textgreater{} 1    1.3068873          1   0.25295901}
\end{Highlighting}
\end{Shaded}
