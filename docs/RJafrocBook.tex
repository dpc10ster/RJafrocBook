...
Eqn. \eqref{eq:ORModel1RMT} models the observed figure-of-merit \(\theta_{i\{c\}}\) as a constant term \(\mu\) plus a treatment dependent term \(\tau_i\) (the treatment-effect) with the constraint:
...
\CommentTok{\#\textgreater{} 1    1.2311613          1   0.26718131}
\end{Highlighting}
\end{Shaded}
