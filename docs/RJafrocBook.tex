...
\begin{itemize}
\item
  There are 100 diseased cases (labeled 0-99) under column \texttt{CaseID} and 100 non-diseased cases (labeled 109-199). \footnote{The non-diseased cases numbered 128 - 199 are not shown above.}\\
\item
