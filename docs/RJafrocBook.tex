...
\hypertarget{case-sampling-induced-variability-of-auc}{%
\subsection{Case sampling induced variability of AUC}\label{case-sampling-induced-variability-of-auc}}
...
\hypertarget{estimating-case-sampling-variability-using-the-delong-method}{%
\section{Estimating case-sampling variability using the DeLong method}\label{estimating-case-sampling-variability-using-the-delong-method}}
...
\hypertarget{bootstrap-estimation-of-auc-case-sampling-variability}{%
\section{Bootstrap estimation of AUC case-sampling variability}\label{bootstrap-estimation-of-auc-case-sampling-variability}}
...
\hypertarget{jackknife-estimation-of-auc-case-sampling-variability}{%
\section{Jackknife estimation of AUC case-sampling variability}\label{jackknife-estimation-of-auc-case-sampling-variability}}
...
\hypertarget{estimating-auc-case-sampling-variability-using-calibrated-simulator}{%
\subsection{Estimating AUC case-sampling variability using calibrated simulator}\label{estimating-auc-case-sampling-variability-using-calibrated-simulator}}
...
7.7.1: Code Output
\textgreater{} source(`\textasciitilde/book2/02 A ROC analysis/A7 Sources of variability in AUC/software/mainCalSimulator.R')
...
\begin{quote}
source(`\textasciitilde/book2/02 A ROC analysis/A7 Sources of variability in AUC/software/mainCalSimulator.R')
...
\hypertarget{dependence-of-auc-on-reader-expertise}{%
\section{Dependence of AUC on reader expertise}\label{dependence-of-auc-on-reader-expertise}}
...
\hypertarget{dependence-of-auc-on-modality}{%
\section{Dependence of AUC on modality}\label{dependence-of-auc-on-modality}}
...
\hypertarget{effect-on-empirical-auc-of-variations-in-thresholds-and-numbers-of-bins}{%
\section{Effect on empirical AUC of variations in thresholds and numbers of bins}\label{effect-on-empirical-auc-of-variations-in-thresholds-and-numbers-of-bins}}
...
\hypertarget{empirical-vs.-fitted-aucs}{%
\section{Empirical vs.~fitted AUCs}\label{empirical-vs.-fitted-aucs}}
...
\CommentTok{\#\textgreater{} 1    1.1810219          1   0.27714805}
\end{Highlighting}
\end{Shaded}
