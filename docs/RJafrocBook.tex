...
\CommentTok{\#\textgreater{} 1     1.079472          1   0.29881571}
\end{Highlighting}
\end{Shaded}
...
The second example shows application of the \texttt{RJafroc} package function \texttt{StSignificanceTesting()} to \texttt{dataset02}: this function encapsulates all formulae discussed previously and accomplishes all analyses with one function call.
...
\tightlist
\item
  \texttt{RRRC\$ciAvgRdrEachTrt} contains confidence intervals for each treatment, averaged over readers, i.e., \(CI_{1-\alpha,RRRC,\theta_{i \bullet}}\).
\end{itemize}
...
\tightlist
\item
  Displayed next are the results of FRRC analysis, contained in the \texttt{st1\$FRRC} \texttt{list} object.
\item
...
\tightlist
\item
  \texttt{st1\$RRFC\$ciDiffTrt} contains confidence intervals for the inter-treatment difference FOMs, averaged over readers, i.e., \(CI_{1-\alpha,RRFC,\theta_{i \bullet} - \theta_{i' \bullet}}\).
\end{itemize}
...
\tightlist
\item
  In this example \texttt{ndf} = 4 because there are I = 5 treatments. Since the p-value is less than 0.05, at least one treatment-pairing is guaranteed to be significantly different from zero.
\end{itemize}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(st4}\OperatorTok{$}\NormalTok{RRRC}\OperatorTok{$}\NormalTok{ciDiffTrt[,}\OperatorTok{{-}}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\OperatorTok{:}\DecValTok{5}\NormalTok{)])}
\CommentTok{\#\textgreater{}                Estimate       CILower       CIUpper}
\CommentTok{\#\textgreater{} trt1{-}trt2 {-}0.0068562500 {-}0.0315514439  0.0178389439}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.0306145833  0.0059193894  0.0553097773}
\CommentTok{\#\textgreater{} trt1{-}trt4 {-}0.0160354167 {-}0.0407306106  0.0086597773}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(st4}\OperatorTok{$}\NormalTok{RRRC}\OperatorTok{$}\NormalTok{ciAvgRdrEachTrt[,}\OperatorTok{{-}}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{6}\NormalTok{)])}
\CommentTok{\#\textgreater{}        Estimate    CILower    CIUpper}
\CommentTok{\#\textgreater{} trt1 0.75321875 0.68413193 0.82230557}
\CommentTok{\#\textgreater{} trt2 0.76007500 0.69727167 0.82287833}
\CommentTok{\#\textgreater{} trt3 0.72260417 0.66128414 0.78392420}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(st4}\OperatorTok{$}\NormalTok{FRRC}\OperatorTok{$}\NormalTok{ciDiffTrt[,}\OperatorTok{{-}}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\OperatorTok{:}\DecValTok{4}\NormalTok{)])}
\CommentTok{\#\textgreater{}                Estimate        PrGTt       CILower      CIUpper}
\CommentTok{\#\textgreater{} trt1{-}trt2 {-}0.0068562500 0.6927087308 {-}0.0409002793  0.027187779}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.0306145833 0.0779118871 {-}0.0034294460  0.064658613}
\CommentTok{\#\textgreater{} trt1{-}trt4 {-}0.0160354167 0.3554604706 {-}0.0500794460  0.018008613}
\CommentTok{\#\textgreater{} trt1{-}trt5  0.0388437500 0.0253859867  0.0047997207  0.072887779}
\CommentTok{\#\textgreater{} trt2{-}trt3  0.0374708333 0.0310289993  0.0034268040  0.071514863}
\CommentTok{\#\textgreater{} trt2{-}trt4 {-}0.0091791667 0.5967708242 {-}0.0432231960  0.024864863}
\CommentTok{\#\textgreater{} trt2{-}trt5  0.0457000000 0.0085768050  0.0116559707  0.079744029}
\CommentTok{\#\textgreater{} trt3{-}trt4 {-}0.0466500000 0.0072992573 {-}0.0806940293 {-}0.012605971}
\CommentTok{\#\textgreater{} trt3{-}trt5  0.0082291667 0.6352831698 {-}0.0258148626  0.042273196}
\CommentTok{\#\textgreater{} trt4{-}trt5  0.0548791667 0.0016137424  0.0208351374  0.088923196}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(st4}\OperatorTok{$}\NormalTok{FRRC}\OperatorTok{$}\NormalTok{ciAvgRdrEachTrt[,}\OperatorTok{{-}}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{5}\NormalTok{)])}
\CommentTok{\#\textgreater{}        Estimate    CILower}
\CommentTok{\#\textgreater{} trt1 0.75321875 0.71050187}
\CommentTok{\#\textgreater{} trt2 0.76007500 0.71511208}
\CommentTok{\#\textgreater{} trt3 0.72260417 0.68006466}
\CommentTok{\#\textgreater{} trt4 0.76925417 0.72752547}
\CommentTok{\#\textgreater{} trt5 0.71437500 0.66947702}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(st4}\OperatorTok{$}\NormalTok{RRFC}\OperatorTok{$}\NormalTok{FTests)}
\CommentTok{\#\textgreater{}           DF          MS     FStat             p}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(st4}\OperatorTok{$}\NormalTok{RRFC}\OperatorTok{$}\NormalTok{ciDiffTrt[,}\OperatorTok{{-}}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{5}\NormalTok{)])}
\CommentTok{\#\textgreater{}                Estimate      CILower       CIUpper}
\CommentTok{\#\textgreater{} trt1{-}trt2 {-}0.0068562500 {-}0.026920472  0.0132079720}
\CommentTok{\#\textgreater{} trt1{-}trt3  0.0306145833  0.010550361  0.0506788053}
\CommentTok{\#\textgreater{} trt1{-}trt4 {-}0.0160354167 {-}0.036099639  0.0040288053}
