...
\NormalTok{  a1 \textless{}{-}}\StringTok{ }\KeywordTok{array}\NormalTok{(}\DataTypeTok{dim =}\NormalTok{ P)}
\NormalTok{  b1 \textless{}{-}}\StringTok{ }\KeywordTok{array}\NormalTok{(}\DataTypeTok{dim =}\NormalTok{ P)}
...
\NormalTok{          a1[p] \textless{}{-}}\StringTok{ }\NormalTok{temp}\OperatorTok{$}\NormalTok{a}
\NormalTok{          b1[p] \textless{}{-}}\StringTok{ }\NormalTok{temp}\OperatorTok{$}\NormalTok{b}
...
\CommentTok{\#\textgreater{} 1    1.2305974          1   0.26729089}
\end{Highlighting}
\end{Shaded}
