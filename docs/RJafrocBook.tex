...
\CommentTok{\#\textgreater{} 1 1 1.060334}
\CommentTok{\#\textgreater{} 2 2 0.904013}
\CommentTok{\#\textgreater{} 3 3 1.839825}
\CommentTok{\#\textgreater{} 4 4 4.588530}
\CommentTok{\#\textgreater{} 5 5 3.747632}
\CommentTok{\#\textgreater{} 6 6 6.298399}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  The functions (for \texttt{Var} and \texttt{Cov1} using bootstrap, jackknife, and the DeLong methods) are not displayed (but they are compiled). To display them download the repository and look at the corresponding \texttt{Rmd} file.
\end{itemize}

The following code chunk extracts (using the \texttt{DfExtractDataset()} function) single-reader multiple-treatment ROC data for \texttt{dataset02}.
...
* jk = jackknife method
* bs = boostrap method, with B bootstraps and \texttt{seed} = seed
...
\NormalTok{ret2 \textless{}{-}}\StringTok{ }\KeywordTok{VarCov1\_Bs}\NormalTok{(zik1, zik2, }\DecValTok{2000}\NormalTok{, }\DataTypeTok{seed =} \DecValTok{100}\NormalTok{) }\CommentTok{\# 2000 bootstraps}
