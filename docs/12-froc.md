...
* the free-response ROC (FROC) [@chakraborty1989maximum; @RN897; @bunch1977free; @RN621; @RN206; @RN1385]; 
...
In the first two clinical applications of the FROC paradigm [@RN621; @RN620] the marks and ratings were indicated by a grease pencil on an acrylic overlay aligned, in a reproducible way, to the CRT displayed chest image. Credit for a correct detection and localization, termed a lesion-localization or LL-event ^[The proper terminology for this paradigm has evolved. Older publications and some newer ones refer to these as true positive (TP) event, thereby confusing a ROC related term that does not involve search with one that does.], was given only if a mark was sufficiently close to an actual diseased region; otherwise, the observer’s mark-rating pair was scored as a non-lesion localization or NL-event. 
...
<div class="figure">
<img src="12-froc_files/figure-html/froc-paradigm-plots-1.png" alt="FROC plots: top row correspond to raw data population plots and the lower row to binned plots wthe fewer cases, see details below." width="672" />
...
<div class="figure">
<img src="12-froc_files/figure-html/froc-paradigm-plots2-1.png" alt="The left figure is the raw FROC curve for $\mu=10$ and the right figure is for $\mu=0.01$, see details below." width="672" />
