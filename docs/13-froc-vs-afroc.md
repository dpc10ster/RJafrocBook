...
\caption{(\#tab:froc-vs-afroc-cad-optim-table)Summary of CAD optimal threshold simulations: "measure" refers to a performance measure: AUC, NLF or LLF; the labels are as follows: AUC_10 is the wAFROC AUC for lambda = 10, AUC_01 is the wAFROC AUC for lambda = 01, NLF_10 is NLF for lambda = 1, ..., LLF_01 is LLF for lambda = 1.}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
measure & muVal1 & muVal1.5 & muVal2 & muVal2.5\\
\hline
AUC10 & 0.50464 & 0.56108 & 0.69017 & 0.82014\\
\hline
AUC01 & 0.59410 & 0.78500 & 0.87782 & 0.93210\\
\hline
NLF10 & 0.00968 & 0.09269 & 0.48400 & 0.32303\\
\hline
LLF10 & 0.01129 & 0.18797 & 0.65545 & 0.79339\\
\hline
NLF01 & 0.38209 & 0.41194 & 0.30896 & 0.23170\\
\hline
LLF01 & 0.47917 & 0.74896 & 0.85539 & 0.91473\\
\hline
\end{tabular}
\end{table}
