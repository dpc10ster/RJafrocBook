...
`ncases` is a list containing the number of cases `r ncases$K` and expected power `r ncases$power`. Compare the number of cases to the RRRC value used in Chapter TBA.
...
The required number of cases is `r ncases$K` and expected power is `r ncases$power`. Compare the number of cases to the FRRC value used in Chapter TBA.
...
The required number of cases is `r ncases$K` and expected power is `r ncases$power`. Compare the number of cases to the RRFC value used in Chapter TBA.
