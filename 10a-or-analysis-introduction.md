...
chi1T <- (I-1)*msT/(var-cov1)
pval <- pchisq(chi1T,I-1,lower.tail = F)
ci <- array(dim = 2)
...
t.test(pv[1,1,], pv[2,1,], paired = T, var.equal = T)
```
...
## 	Paired t-test
## 
## data:  pv[1, 1, ] and pv[2, 1, ]
## t = -1.1046, df = 113, p-value = 0.2717
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -0.07872449  0.02236378
## sample estimates:
...
## t = 0.610429, df = 113, p-value = 0.5428
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -0.035437058  0.066999055
## sample estimates:
## mean of the differences 
##             0.015780998
```
