...
```{r, cache = TRUE, attr.source = ".numberLines", echo=FALSE}
...
froc <- ret$froc$Plot
wafroc <- ret$wafroc$Plot
```


```{r froc-paradigm-froc-vs-afroc-plot1, fig.cap="Left panel: FROC curves for the CAD observer (red line) and RAD observer (green line); Right panel: corresponding wAFROC curves", fig.show='hold', echo=FALSE}
grid.arrange(froc,wafroc,ncol=2)
```
