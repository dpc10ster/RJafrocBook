...
The `seed` variable, set to 201 at line 1, is equivalent to the case sample index $c$. Different values of `seed` correspond to different case samples. Line 2 sets the value of $\mu$ to 0.8, the average figure of merit, appearing in Eqn. \@ref(eq:or-sampling-model-multiple-treatments). 
