...
This code illustrates fixed reader random case sample size estimation. Assumed are 10 readers and 133 cases `r J <- 10; K <- 133` in the pivotal study. 
...
This code illustrates random reader random case sample size estimation. Assumed are 10 readers and 53 cases `r J <- 10; K <- 53` in the pivotal study. 
