...
for (Row in 1:9) {
    ...
    plotArr[[Row]] <- PlotBMErrBar(a, b, rocDataTable[Row,,], Row)
}
...
```{r rsm-evidence-binormal-plots1, fig.cap="RSM generated ROC points using parameters and seeds specified in Table 17.2 and corresponding binormal model fitted curves. Plots 1, 2, 3.", fig.show='hold', echo=FALSE, fig.pos='H'}
grid.arrange(plotArr[[1]], plotArr[[2]], plotArr[[3]],plotArr[[4]], plotArr[[5]], plotArr[[6]], plotArr[[7]], plotArr[[8]], plotArr[[9]], nrow = 3, ncol = 3)
```             
