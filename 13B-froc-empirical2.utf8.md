...
<div class="figure">
<img src="13B-froc-empirical2_files/figure-html/froc-afroc-roc-raw-seed1-1.png" alt="Raw FROC, AFROC and ROC plots with seed = 1: Plots A, B, C are for $K_1 = 5$ and $K_2 = 7$ cases while plots D, E, F are for $K_1 = 50$ and $K_2 = 70$ cases." width="672" />
...
<div class="figure">
<img src="13B-froc-empirical2_files/figure-html/froc-afroc-roc-raw-seed2-1.png" alt="Raw FROC, AFROC and ROC plots with seed = 2: Plots A, B, C are for $K_1 = 5$ and $K_2 = 7$ cases while plots D, E, F are for $K_1 = 50$ and $K_2 = 70$ cases." width="672" />
...
<div class="figure">
<img src="13B-froc-empirical2_files/figure-html/froc-afroc-chance-level-1.png" alt="Plot A is the near guessing observer's FROC and plot B is the corresponding AFROC for $\mu=0.01$." width="672" />
...
<div class="figure">
<img src="13B-froc-empirical2_files/figure-html/froc-afroc-roc-binned-seed1-1.png" alt="Binned FROC, AFROC and ROC plots with seed = 1: Plots A, B, C are for $K_1 = 5$ and $K_2 = 7$ cases while plots D, E, F are for $K_1 = 50$ and $K_2 = 70$ cases" width="672" />
...
<div class="figure">
<img src="13B-froc-empirical2_files/figure-html/froc-afroc-roc-binned-seed2-1.png" alt="Binned FROC, AFROC and ROC plots with seed = 2: Plots A, B, C are for $K_1 = 5$ and $K_2 = 7$ cases while plots D, E, F are for $K_1 = 50$ and $K_2 = 70$ cases" width="672" />
