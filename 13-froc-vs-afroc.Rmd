...
cell3 <- as.character(format(fomCad1B, digits = dig))
cell4 <- as.character(format(fomCad1D, digits = dig))
...
cell_14 <- as.character(format(fomRad1B, digits = dig))
cell_15 <- as.character(format(fomRad1D, digits = dig))
...
cell_24 <- as.character(format(fomRad2B, digits = dig))
cell_25 <- as.character(format(fomRad2D, digits = dig))
...
cell_34 <- as.character(format(fomRad3B, digits = dig))
cell_35 <- as.character(format(fomRad3D, digits = dig))
```
...
* For the same figure label the CAD plots are identical for the three figures, i.e., a *fixed* CAD dataset is being compared to *varying* RAD datasets.
* The first RAD dataset might be considered an average radiologist, the second one that is a super-expert and the third is only nominally better than CAD.
* 
