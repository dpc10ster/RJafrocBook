...
```{r showRocCrTruthSheet, echo=FALSE,out.width="50%",out.height="20%",fig.cap="Truth worksheet for file rocCr.xlsx",fig.show='hold',fig.align='center'}
...
```{r showRocCrFpSheet, echo=FALSE,out.width="50%",out.height="20%",fig.cap="FP worksheet for file rocCr.xlsx",fig.show='hold',fig.align='center'}
...
```{r showRocCrTpSheet, echo=FALSE,out.width="50%",out.height="20%",fig.cap="TP worksheet for file rocCr.xlsx",fig.show='hold',fig.align='center'}
