...
```{r, echo=FALSE,out.width="50%",out.height="20%",fig.cap="Fig. 1 Truth worksheet for file rocCr.xlsx",fig.show='hold',fig.align='center'}
...
```{r, echo=FALSE,out.width="50%",out.height="20%",fig.cap="Fig. 1 FP worksheet for file rocCr.xlsx",fig.show='hold',fig.align='center'}
...
```{r, echo=FALSE,out.width="50%",out.height="20%",fig.cap="Fig. 1 TP worksheet for file rocCr.xlsx",fig.show='hold',fig.align='center'}
