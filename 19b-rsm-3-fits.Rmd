...
ret <- slopesConvVsRsm(type = "pearson", fileNames)
...
```{r rsm-3-fits-plots-12, fig.cap="TBA", fig.show='hold', echo=FALSE}
grid.arrange(ret$p1[[1]], ret$p1[[2]], ncol = 2)
```

```{r rsm-3-fits-plots-34, fig.cap="TBA", fig.show='hold', echo=FALSE}
grid.arrange(ret$p1[[3]], ret$p1[[4]], ncol = 2)
```


```{r rsm-3-fits-plots-56, fig.cap="TBA", fig.show='hold', echo=FALSE}
grid.arrange(ret$p1[[5]], ret$p1[[6]], ncol = 2)
```



```{r rsm-3-fits-inter-corr-table1, echo=FALSE}
