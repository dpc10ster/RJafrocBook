...
```{r rsm-3-fits-datasets, echo=FALSE,fig.cap="Screen shot of `RJafroc` help file showing the datasets included with the current distribution (v2.0.1).",fig.show='hold',fig.align='center'}
