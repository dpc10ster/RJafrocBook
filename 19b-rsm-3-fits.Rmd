...
```{r rsm-3-fits-histo-slopes1, fig.cap="TBA.", fig.show='hold', echo=FALSE}
...
```{r rsm-3-fits-histo-slopes, fig.cap="TBA.", fig.show='hold', echo=FALSE}
p1 <- retCI$histSlopeProRsm
p2 <- retCI$histSlopeCbmRsm
gA <- ggplot2::ggplotGrob(p1)
gB <- ggplot2::ggplotGrob(p2)
...
grid.arrange(ret$p1[[3]], ret$p2[[4]], ncol = 2)
```
