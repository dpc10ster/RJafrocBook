...
```{r froc-meanings-numerical, echo = FALSE, cache=TRUE}
K1 <- 4;K2 <- 4
...
knitr::kable(df, caption = "Layout of mark-rating  pairs on non-diseased cases; UM denotes an unmarked non-diseased case.", escape = FALSE)
```
...
disTable[6,]  <- c("3", "2", "3221", "",  "3222", "",   "", "0.4", "UM")
...
colnames(df) <- c("",
                  ...
                  "$\\text{weights}$",
                  "$\\text{Label}$")
knitr::kable(df, caption = "Layout of mark-rating pairs on diseased cases; UM denotes an unmarked lesion.", escape = FALSE)
```
