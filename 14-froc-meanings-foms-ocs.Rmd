...
frocData <- SimulateFrocDatasetNoSeed(
  mu = mu, 
  lambda = lambda, 
  nu = nu,
  zeta1 = zeta1,
...
```{r plots-p1-p2, fig.cap="Left: AFROC plot; Right: corresponding wAFROC plot.", fig.show='hold', echo=FALSE}
...
```{r linearPlotAFROC, echo = FALSE, cache=TRUE}
K1 <- 4;K2 <- 4
seed <- 1;set.seed(seed)
maxLL <- 2;Lk2 <- ceiling(runif(K2) * maxLL) 
mu <- 2;lambda <- 1;nu <- 1 ;zeta1 <- -1
frocDataRaw <- SimulateFrocDatasetNoSeed(
  mu = mu, 
  lambda = lambda, 
  nu = nu, 
  zeta1 = zeta1,
...
```{r linearPlotwAFROC, echo=FALSE, cache=TRUE}
K1 <- 4;K2 <- 4
seed <- 1;set.seed(seed)
maxLL <- 2;Lk2 <- ceiling(runif(K2) * maxLL) 
mu <- 2;lambda <- 1;nu <- 1 ;zeta1 <- -1
...
```{r afrocPlot, echo=FALSE, cache=TRUE}
K1 <- 4;K2 <- 4
seed <- 1;set.seed(seed)
maxLL <- 2;Lk2 <- ceiling(runif(K2) * maxLL) 
mu <- 2;lambda <- 1;nu <- 1 ;zeta1 <- -1
...
```{r wafrocPlot, echo = FALSE, cache=TRUE}
K1 <- 4;K2 <- 4
seed <- 1;set.seed(seed)
maxLL <- 2;Lk2 <- ceiling(runif(K2) * maxLL) 
mu <- 2;lambda <- 1;nu <- 1 ;zeta1 <- -1
