...
disTable[1,]  <- c("", "", "1211", "1.512", "1212", "0.852",  "1", "D")
disTable[2,]  <- c("1", "1", "1221", "", "1222", "", "", "")
disTable[3,]  <- c("", "", "2211", "", "2212", "-0.215", "1", "G")
disTable[4,]  <- c("2", "1", "2221", "", "2222", "", "",  "")

disTable[5,]  <- c("", "", "3211", "", "3212", "1.588", "0.6", "C")
disTable[6,]  <- c("3", "2", "3221", "", "3222", "", "0.4", "UM")
disTable[7,]  <- c("", "", "4211", "", "4212", "2.944", "0.4", "A")
disTable[8,]  <- c("4", "2", "4221", "", "4222", "1.984", "0.6", "B")
