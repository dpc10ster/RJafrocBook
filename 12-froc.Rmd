...
for (i in 1:3) {
  ...
  if (i == 1) figA <- froc$Plot
  if (i == 2) figB <- froc$Plot
  if (i == 3) figC <- froc$Plot
}
...
for (i in 1:3) {
  ...
  if (i == 1) figD <- froc$Plot
  if (i == 2) figE <- froc$Plot
  if (i == 3) figF <- froc$Plot
}

```

```{r froc-paradigm-plots, fig.cap="FROC plots: top row correspond to raw data population plots and the lower row to binned plots wthe fewer cases, see details below.", echo = FALSE, fig.show='hold'}
...
for (i in 1:2) {
  ...
  if (i == 1) figG <- froc$Plot
  if (i == 2) figH <- froc$Plot
}

```

```{r froc-paradigm-plots2, fig.cap="The left figure is the raw FROC curve for $\\mu=10$ and the right figure is for $\\mu=0.01$, see details below.", echo = FALSE, fig.show='hold'}
