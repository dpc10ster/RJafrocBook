...
colnames(df) <- c("ROC Rating", "Observers Description", "FROC Rating", "Observers Description")
```
...
```{r HelpSimulateFrocDataset, echo=FALSE, fig.cap="Help page for RJafroc function SimulateFrocDataset",fig.show='hold',fig.align='center'}
knitr::include_graphics("images/12-froc/SimulateFrocDataset.png")
``` 
...
```{r froc-paradigm-plots, fig.cap="FROC plots: top row correspond to raw data population plots and the lower row to binned plots wthe fewer cases.", echo = FALSE, fig.show='hold'}
grid.arrange(figA,figB,figC,figD,figE,figF, nrow=2,ncol=3)
```
...
```{r froc-paradigm-plots2, fig.cap="The left figure is the raw FROC curve for $\\mu=10$ and the right figure is for $\\mu=0.01$.", echo = FALSE, fig.show='hold'}
grid.arrange(figG,figH, ncol=2)
```
