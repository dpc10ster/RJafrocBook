...
allCells[1,1,] <- do_one_ST_RRFC_1T (ret_1T_RRFC_PCL_0_05,"PCL_0_05","1T-RRFC")  
allCells[1,2,] <- do_one_ST_RRRC_2T (ret_2T_RRRC_PCL_0_05,"PCL_0_05","2T-RRRC")  
allCells[1,3,] <- do_one_ST_RRRC_1T (ret_1T_RRRC_PCL_0_05,"PCL_0_05","1T-RRRC")  

allCells[1,4,] <- do_one_ST_RRFC_1T (ret_1T_RRFC_PCL_0_2,"PCL_0_2","1T-RRFC")  
allCells[1,5,] <- do_one_ST_RRRC_2T (ret_2T_RRRC_PCL_0_2,"PCL_0_2","2T-RRRC")  
allCells[1,6,] <- do_one_ST_RRRC_1T (ret_1T_RRRC_PCL_0_2,"PCL_0_2","1T-RRRC")  

allCells[1,7,] <- do_one_ST_RRFC_1T (ret_1T_RRFC_PCL_1,"PCL_1","1T-RRFC")  
allCells[1,8,] <- do_one_ST_RRRC_2T (ret_2T_RRRC_PCL_1,"PCL_1","2T-RRRC")  
allCells[1,9,] <- do_one_ST_RRRC_1T (ret_1T_RRRC_PCL_1,"PCL_1","1T-RRRC")  

allCells[1,10,] <- do_one_ST_RRFC_1T (ret_1T_RRFC_AUC,"Wilcoxon","1T-RRFC")  
allCells[1,11,] <- do_one_ST_RRRC_2T (ret_2T_RRRC_AUC,"Wilcoxon","2T-RRRC")  
allCells[1,12,] <- do_one_ST_RRRC_1T (ret_1T_RRRC_AUC,"Wilcoxon","1T-RRRC")  
...
allCells[2,1,1:8] <- do_one_parms_RRFC_1T (ret_1T_RRFC_PCL_0_05,"PCL_0_05","1T-RRFC")  
allCells[2,2,1:8] <- do_one_parms_RRRC_2T (ret_2T_RRRC_PCL_0_05,"PCL_0_05","2T-RRRC")  
allCells[2,3,1:8] <- do_one_parms_RRRC_1T (ret_1T_RRRC_PCL_0_05,"PCL_0_05","1T-RRRC")  

allCells[2,4,1:8] <- do_one_parms_RRFC_1T (ret_1T_RRFC_PCL_0_2,"PCL_0_2","1T-RRFC")  
allCells[2,5,1:8] <- do_one_parms_RRRC_2T (ret_2T_RRRC_PCL_0_2,"PCL_0_2","2T-RRRC")  
allCells[2,6,1:8] <- do_one_parms_RRRC_1T (ret_1T_RRRC_PCL_0_2,"PCL_0_2","1T-RRRC")  

allCells[2,7,1:8] <- do_one_parms_RRFC_1T (ret_1T_RRFC_PCL_1,"PCL_1","1T-RRFC")  
allCells[2,8,1:8] <- do_one_parms_RRRC_2T (ret_2T_RRRC_PCL_1,"PCL_1","2T-RRRC")  
allCells[2,9,1:8] <- do_one_parms_RRRC_1T (ret_1T_RRRC_PCL_1,"PCL_1","1T-RRRC")  

allCells[2,10,1:8] <- do_one_parms_RRFC_1T (ret_1T_RRFC_AUC,"Wilcoxon","1T-RRFC")  
allCells[2,11,1:8] <- do_one_parms_RRRC_2T (ret_2T_RRRC_AUC,"Wilcoxon","2T-RRRC")  
allCells[2,12,1:8] <- do_one_parms_RRRC_1T (ret_1T_RRRC_AUC,"Wilcoxon","1T-RRRC")  
