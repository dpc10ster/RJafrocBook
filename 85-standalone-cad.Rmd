...
cells[1,]  <- c("PCL-0.05", "RRFC",    "0.463",              "0", "0.506", "(0.437, 0.576)", "0.0439", "(-0.026, 0.113)",  "2.115",   "8",  "0.184")
cells[2,]  <- c("PCL-0.05", "2T-RRRC", "0.463", "(0.339, 0.586)", "0.506", "(0.392, 0.621)", "0.0439",  "(0.100, 0.188)",  "0.361", "274",  "0.548")
cells[3,]  <- c("PCL-0.05", "1T-RRRC", "0.463",             "NA", "0.506", "(0.363, 0.650)", "0.0439",  "(0.100, 0.188)",  "0.361", "274",  "0.548")

cells[4,]  <- c("PCL-0.2", "RRFC",     "0.592",              "0", "0.711", "(0.670, 0.752)", "0.119",   "(0.079, 0.160)",  "45.45",   "8", "0.0001")
cells[5,]  <- c("PCL-0.2", "2T-RRRC",  "0.592", "(0.478, 0.705)", "0.711", "(0.633, 0.789)", "0.119",   "(0.004, 0.235)",  "4.147", "961", "0.0420")
cells[6,]  <- c("PCL-0.2", "1T-RRRC",  "0.592",             "NA", "0.711", "(0.600, 0.826)", "0.119",   "(0.004, 0.235)",  "4.147", "961", "0.0420")

cells[7,]  <- c("PCL-1", "RRFC",       "0.675",              "0", "0.783", "(0.740, 0.827)", "0.108",   "(0.065, 0.152)",  "32.98", "8",   "0.0004")
cells[8,]  <- c("PCL-1", "2T-RRRC",    "0.675", "(0.571, 0.779)", "0.783", "(0.712, 0.854)", "0.108",   "(0.005, 0.212)",   "4.20", "493", "0.0409")
cells[9,]  <- c("PCL-1", "1T-RRRC",    "0.675",             "NA", "0.783", "(0.680, 0.887)", "0.108",   "(0.005, 0.212)",   "4.20", "493", "0.0409")

cells[10,]  <- c("AUC", "RRFC",        "0.817",              "0", "0.849", "(0.826, 0.871)", "0.032",   "(0.009, 0.055)",   "10.3", "8",   "0.0124")
cells[11,]  <- c("AUC", "2T-RRRC",     "0.817", "(0.752, 0.882)", "0.849", "(0.807, 0.890)", "0.032",  "(0.031, -0.094)",  "0.986", "878", "0.3210")
cells[12,]  <- c("AUC", "1T-RRRC",     "0.817",             "NA", "0.849", "(0.786, 0.911)", "0.032",  "(0.031, -0.094)",  "0.986", "878", "0.3210")

df <- as.data.frame(cells, stringsAsFactors = FALSE)
colnames(df) <- c("FOM", "Method", "theta0", "CItheta0", "thetabullet", "CIthetabullet", "psi0", "CIpsi0",  "F", "ddf", "p")
kable(df, caption = "TBA", booktabs = TRUE) %>% collapse_rows(columns = c(1, 3, 5, 7, 8, 9, 10, 11), valign = "middle") %>% kable_styling(latex_options = c("basic", "scale_down", "hold_position"), row_label_position = "c") 
```
...
df <- as.data.frame(cells, stringsAsFactors = FALSE)
colnames(df) <- c("FOM", "Method", "$\\sigma_R^2$", "varTR", "Cov1", "Cov2", "Cov3", "Var")
kable(df, caption = "TBA", booktabs = TRUE) %>% collapse_rows(columns = c(1), valign = "middle") %>% kable_styling(latex_options = c("basic", "scale_down", "hold_position"), row_label_position = "c") 
```
