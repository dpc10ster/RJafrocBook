...
\item
  It is intended as an online update to my ``physical'' book (Chakraborty \protect\hyperlink{ref-RN2680}{2017}). Since its publication in 2017 the \texttt{RJafroc} package, on which the \texttt{R} code examples in the book depend, has evolved considerably, causing many of the examples to ``break''. This also gives me the opportunity to improve on the book and include additional material.
\item
...
\tightlist
\item
  In the hard-copy version of my book (Chakraborty \protect\hyperlink{ref-RN2680}{2017}) the online distribution mechanism was \texttt{BitBucket}.
\item
...
\tightlist
\item
  The purpose of this chapter is to explain the data format of the input Excel file and to introduce the capabilities of the function \texttt{DfReadDataFile()}. Background on observer performance methods are in my book (Chakraborty \protect\hyperlink{ref-RN2680}{2017}).
\item
  I will start with Receiver Operating Characteristic (ROC) data (Metz \protect\hyperlink{ref-RN1766}{1978}), as this is by far the simplest paradigm.
\item
...
\tightlist
\item
  See my book Chakraborty (\protect\hyperlink{ref-RN2680}{2017}) for full details.
\item
  In the Free-response Receiver Operating Characteristic (FROC) paradigm (Chakraborty \protect\hyperlink{ref-RN761}{1989}) the observer searches each case for signs of \textbf{localized disease} and marks and rates localized regions that are sufficiently suspicious for disease presence.
\item
...
\includegraphics{04-ratings-paradigm_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\includegraphics{04-ratings-paradigm_files/figure-latex/unnamed-chunk-5-1.pdf}
...
In this chapter the univariate binormal model (Dorfman and Alf \protect\hyperlink{ref-RN212}{1968}) is described, in which one is dealing with one ROC rating per case, as in a single observer interpreting cases, one at a time, in a single modality. By convention the qualifier ``univariate'' is often omitted, i.e., it is implicit. In a later chapter a bivariate binormal model will be described where each case yields two ratings, as in a single observer interpreting cases in two modalities, or equivalently, two observers interpreting cases in a single modality.
...
The reason for the \((a,b)\) instead of the \((\mu,\sigma)\) notation is that Dorfman and Alf assumed, in their seminal paper (Dorfman and Alf \protect\hyperlink{ref-RN1081}{1969}), that the diseased distribution (signal distribution in signal detection theory) had unit variance, and the non-diseased distribution (noise) had standard deviation \(b\) (\(b > 0\)) or variance \(b^2\), and that the separation of the two distributions was \(a\), see figure below. In this example, \(a = 1.11\) and \(b = 0.556\). Dorfman and Alf's fundamental contribution, namely estimating these parameters from ratings data, to be described below, led to the widespread usage of the \((a,b)\) parameters, estimated by their software (RSCORE), and its newer variants (e.g., RSCORE --II, ROCFIT and ROCKIT).
...
Note the usage of the \texttt{RJafroc} package (Chakraborty, Philips, and Zhai \protect\hyperlink{ref-R-RJafroc}{2020}). Specifically, the function \texttt{FitBinormalRoc}. The ratings table is converted to an \texttt{RJafroc} dataset object, followed by application of the fitting function. The results, contained in \texttt{retFit} should be compared to those obtained from the \href{http://www.rad.jhmi.edu/jeng/javarad/roc/JROCFITi.html}{website implementation of ROCFIT}.

\hypertarget{validating-the-fitting-model}{%
\subsection{Validating the fitting model}\label{validating-the-fitting-model}}

The above ROC curve is a good visual fit to the observed operating points. Quantification of the validity of the fitting model is accomplished by calculating the Pearson goodness-of-fit test (Pearson \protect\hyperlink{ref-RN2656}{1900}), also known as the chi-square test, which uses the statistic defined by (Larsen and Marx \protect\hyperlink{ref-RN1492}{2001}):
...
A recent example is Fig. 1 in the publication resulting from the Digital Mammographic Imaging Screening Trial (DMIST) clinical trial (Pisano et al. \protect\hyperlink{ref-RN1784}{2005}) involving 49,528 asymptomatic women from 33 clinical sites and involving 153 radiologists, where each of the film modality ROC plots crosses the chance diagonal and hooks upwards to (1,1), which as is known, results anytime .
...
To this day the binormal model is widely used to fit ROC datasets. In spite of its limitations, the binormal model has been very useful in bringing a level of quantification to this field that did not exist prior to the work (Dorfman and Alf \protect\hyperlink{ref-RN212}{1968}) by Dorfman and Alf.
...
For the moment I restrict to fully paired data (i.e., each case is interpreted by all readers in all treatments). There is a long history of how this field has evolved and the author cannot do justice to all methods that are currently available. Some of the methods (Toledano \protect\hyperlink{ref-RN1441}{2003}; Ishwaran and Gatsonis \protect\hyperlink{ref-RN2013}{2000}; Toledano and Gatsonis \protect\hyperlink{ref-RN1451}{1996}) have the advantage that they can handle explanatory variables (termed covariates) that could influence performance, e.g., years of experience, types of cases, etc. Other methods are restricted to specific choices of FOM. Specifically, the probabilistic approach (Clarkson, Kupinski, and Barrett \protect\hyperlink{ref-RN2253}{2006}; Kupinski, Clarkson, and Barrett \protect\hyperlink{ref-RN2254}{2006}; Gallas, Pennello, and Myers \protect\hyperlink{ref-RN2351}{2007}; Gallas \protect\hyperlink{ref-RN2080}{2006}) is restricted to the empirical \(AUC\) under the ROC curve, and is not applicable to other FOMs, e.g., parametrically fitted ROC AUCs or, more importantly, to location specific paradigm FOMs. Instead, the author will focus on methods for which software is readily available (i.e., freely on websites), which have been widely used (the method that the author is about to describe has been used in several hundred publications) and validated via simulations, and which apply to any scalar figure of merit, and therefore widely applicable, for example, to location specific paradigms.
...
The approach (Dorfman, Berbaum, and Metz \protect\hyperlink{ref-RN204}{1992}) taken by DBM was to use the jackknife resampling method to calculate FOM pseudovalues \({Y'}_{ijk}\) defined by (the reason for the prime will become clear shortly):
...
The definitions of the mean-squares below match those (where provided) in (Hillis and Berbaum \protect\hyperlink{ref-RN1476}{2004}, 1261).
...
\begin{itemize}
\item
  We choose \texttt{dataset02} to illustrate calculation of mean squares for pseudovalues. This is referred to in the book as the ``VD'' dataset (Van Dyke et al. \protect\hyperlink{ref-RN1993}{1993}). It consists of 114 cases, 45 of which are diseased, interpreted in two treatments by five radiologists using the ROC paradigm.
\item
...
The denominator of the F-ratio is \(MSTR+MSTC-MSTRC\). This is not a \emph{simple} mean square (I am using terminology in the Satterthwaite papers - he means any mean square defined by equations such as in Equation \eqref{eq:MeanSquares}). Rather it is a \emph{linear combination of mean squares} (with coefficients 1, 1 and -1), and the resulting value could even be negative leading to a negative \(F_{DBM|NH}\), which is an illegal value for a sample from an F-distribution (a ratio of two variances). In 1941 Satterthwaite (Satterthwaite \protect\hyperlink{ref-RN2359}{1941}, \protect\hyperlink{ref-RN2360}{1946}) proposed an approximate degree of freedom for a linear combination of simple mean square quantities. TBA Online Appendix 9.A explains the approximation in more detail. The end result is that the mean square quantity described in Equation \eqref{eq:DefFStatRRRC} has an approximate degree of freedom defined by (this is called the \emph{Satterthwaite's approximation}):
...
The subscript \(Sat\) is for Satterthwaite. From Equation \eqref{eq:ddfSatter} it should be fairly obvious that in general \(ddf_{Sat}\) is not an integer. To accommodate possible negative estimates of the denominator of Equation \eqref{eq:ddfSatter}, the original DBM method (Dorfman, Berbaum, and Metz \protect\hyperlink{ref-RN204}{1992}) proposed, depending on the signs of \(\sigma_{\tau R}^2\) and \(\sigma_{\tau C}^2\), four expressions for the F-statistic and corresponding expressions for \(ddf\). Rather than repeat them here, since they have been superseded by the method described below, the interested reader is referred to Eqn. 6 and Eqn. 7 in Reference (Hillis, Berbaum, and Metz \protect\hyperlink{ref-RN1866}{2008}).

Instead Hillis (Hillis \protect\hyperlink{ref-RN1865}{2007}) proposed the following statistic for testing the null hypothesis:
...
The variances, \(\sigma_{\tau}^2\), \(\sigma_{\tau R}^2\) and \(\sigma_{\tau C}^2\), appearing in Equation \eqref{eq:DeltaCoded}, can be calculated from the observed mean squares using the following equations, see (Hillis and Berbaum \protect\hyperlink{ref-RN1476}{2004}) Eqn. 4,
...
Assuming no replications the expected mean squares are as follows, Table Table \ref{tab:ExpValMs}; understanding how this table is derived, would lead the author well outside his expertise and the scope of this book; suffice to say that these are \emph{unconstrained} estimates (as summarized in the quotation above) which are different from the \emph{constrained} estimates appearing in the original DBM publication (Dorfman, Berbaum, and Metz \protect\hyperlink{ref-RN204}{1992}), Table 9.2; the differences between these two types of estimates is summarized in (Dorfman, Berbaum, and Lenth \protect\hyperlink{ref-RN2079}{1995}). For reference, Table 9.3 is the table published in the most recent paper that I am aware of (Hillis \protect\hyperlink{ref-RN2508}{2014}). All three tables are different! \textbf{In this chapter I will stick to Table Table \ref{tab:ExpValMs} for the subsequent development.}

\begin{longtable}[]{@{}lll@{}}
\caption{Table 9.1 Unconstrained expected values of mean-squares, as in (Dorfman, Berbaum, and Lenth \protect\hyperlink{ref-RN2079}{1995})}\tabularnewline
\toprule
Source & df & E(MS)\tabularnewline
\midrule
\endfirsthead
...
\begin{longtable}[]{@{}lll@{}}
\caption{Table 9.2 Constrained expected values of mean-squares, as in (Dorfman, Berbaum, and Metz \protect\hyperlink{ref-RN204}{1992})}\tabularnewline
\toprule
Source & df & E(MS)\tabularnewline
\midrule
\endfirsthead
...
\begin{longtable}[]{@{}lll@{}}
\caption{Table 9.3 As in Hillis ``marginal-means ANOVA paper'' (Hillis \protect\hyperlink{ref-RN2508}{2014})}\tabularnewline
\toprule
Source & df & E(MS)\tabularnewline
\midrule
\endfirsthead
...
A third method of estimating the covariance (DeLong, DeLong, and Clarke-Pearson \protect\hyperlink{ref-RN112}{1988}), only applicable to the empirical AUC, is not discussed here; however, it is implemented in the software.
...
Eqn. \eqref{eq:F-1RMT} is from §5.4 in (Hillis \protect\hyperlink{ref-RN1865}{2007}) with two covariance terms ``zeroed out'' because they are multiplied by \(J-1 = 0\) (since we are restricting to \(J=1\)).

Or equivalently, in terms of the F-distribution (Hillis et al. \protect\hyperlink{ref-RN1772}{2005}):
...
With definition Eqn. \eqref{eq:DefQuantile}, the \((1-\alpha)\) quantile of the \(\chi_{I-1}^2\) distribution, i.e., \(\chi_{1-\alpha,I-1}^2\), is related to the \((1-\alpha)\) quantile of the \(F_{I-1,\infty}\) distribution, i.e., \(F_{1-\alpha,I-1,\infty}\), as follows (see Hillis et al. \protect\hyperlink{ref-RN1772}{2005}, Eq. 22):
...
\CommentTok{\#\textgreater{} 1    1.3296283          1   0.24887136}
\end{Highlighting}
\end{Shaded}
...
In previous chapters the DBM significance testing procedure (Dorfman, Berbaum, and Metz \protect\hyperlink{ref-RN204}{1992}) for analyzing MRMC ROC data, along with improvements (Hillis \protect\hyperlink{ref-RN2508}{2014}), has been described. Because the method assumes that jackknife pseudovalues can be regarded as independent and identically distributed case-level figures of merit, it has been rightly criticized by Hillis and others (Zhou, McClish, and Obuchowski \protect\hyperlink{ref-zhou2009statistical}{2009}). Hillis states that the method ``works'' but lacks firm statistical foundations (Hillis et al. \protect\hyperlink{ref-RN1772}{2005}; Hillis \protect\hyperlink{ref-RN1865}{2007}; Hillis, Berbaum, and Metz \protect\hyperlink{ref-RN1866}{2008}). I would add that it ``works'' as long as one restricts to the empirical AUC figure of merit. In my book I gave a justification for why the method ``works''. Specifically, the \emph{empirical AUC pseudovalues qualify as case-level FOMs} - this property has also been noted by (Hajian-Tilaki et al. \protect\hyperlink{ref-RN1395}{1997}). However, this property applies \emph{only} to the empirical AUC, so an alternate approach that applies to any figure of merit is highly desirable.

Hillis' has proposed that a method based on an earlier publication (Obuchowski and Rockette \protect\hyperlink{ref-RN1450}{1995}), which does not depend on pseudovalues, is preferable from both conceptual and practical points of view. This chapter is named ``OR Analysis'', where OR stands for Obuchowski and Rockette. The OR method has advantages in being able to handle more complex study designs (Hillis \protect\hyperlink{ref-RN2508}{2014}) that are addressed in subsequent chapters, and applications to other FOMs (e.g., the FROC paradigm uses a rather different FOM from empirical ROC-AUC) are best performed with the OR method.
...
The original paper (Obuchowski and Rockette \protect\hyperlink{ref-RN1450}{1995}) actually proposed a different test statistic \(F_{OR}\):
...
Using the vertical bar notation \(\mid R\) to denote that reader is regarded as a fixed effect (Roe and Metz \protect\hyperlink{ref-RN1124}{1997}\protect\hyperlink{ref-RN1124}{b}), the F -statistic for testing the null hypothesis \(NH: \tau_i = 0 \; (i=1,1,2,...I)\) is (Hillis \protect\hyperlink{ref-RN1865}{2007}):
...
\tightlist
\item
  The third example uses the Federica Zanca dataset (Zanca et al. \protect\hyperlink{ref-RN1882}{2009}), i.e., \texttt{dataset04}, which has five modalities and four readers.
\item
...
\item
  The increased power of FROC analysis has been confirmed in simulation studies (Chakraborty \protect\hyperlink{ref-RN1331}{2002}).
\item
...
\item
  Accuracy of sample size estimation, essentially estimating confidence intervals for statistical power, is addressed in (Chakraborty \protect\hyperlink{ref-RN2027}{2010}).
\end{itemize}
...
The mean squares in this expression can be expressed in terms of the three variance-components appearing in TBA Eqn. (11.6). Hillis and Berbaum (Hillis and Berbaum \protect\hyperlink{ref-RN1476}{2004}) have derived these expression and they will not be repeated here (Eqn. 4 in the cited reference). RJafroc implements a function to calculate the mean squares, \texttt{UtilMeanSquares()}, which allows ddf to be calculated using Eqn. TBA (11.7). The sample size functions in this package need only the three variance-components (the formula for \(ddf_H\) is implemented internally).
...
R(T) is read as ``reader nested within treatment'' (Hillis \protect\hyperlink{ref-RN2508}{2014}).
...
Bunch, P. C., J. F. Hamilton, G. K. Sanderson, and A. H. Simmons. 1977. ``Free Response Approach to Measurement and Characterization of Radiographic Observer Performance.'' Journal Article. In \emph{Application of Optical Instrumentation in Medicine Vi}, edited by Joel E. Gray and William R. Hendee, 0127:124--35. International Society for Optics; Photonics; SPIE. \url{https://doi.org/10.1117/12.955926}.

\leavevmode\hypertarget{ref-RN761}{}%
Chakraborty, Dev P. 1989. ``Maximum Likelihood Analysis of Free-Response Receiver Operating Characteristic (FROC) Data.'' Journal Article. \emph{Medical Physics} 16 (4): 561--68. \url{https://doi.org/10.1118/1.596358}.

\leavevmode\hypertarget{ref-RN1331}{}%
---------. 2002. ``Statistical Power in Observer Performance Studies: A Comparison of the ROC and Free-Response Methods in Tasks Involving Localization.'' Journal Article. \emph{Acad. Radiol.} 9 (2): 147--56. \url{https://doi.org/10.1016/s1076-6332(03)80164-2}.

\leavevmode\hypertarget{ref-RN2680}{}%
---------. 2017. \emph{Observer Performance Methods for Diagnostic Imaging - Foundations, Modeling, and Applications with R-Based Examples}. Book. Boca Raton, FL: CRC Press.

\leavevmode\hypertarget{ref-R-RJafroc}{}%
Chakraborty, Dev, Peter Philips, and Xuetong Zhai. 2020. \emph{RJafroc: Analyzing Diagnostic Observer Performance Studies}. \url{https://dpc10ster.github.io/RJafroc/}.

\leavevmode\hypertarget{ref-RN2027}{}%
Chakraborty, Dev Prasad. 2010. ``Prediction Accuracy of a Sample-Size Estimation Method for ROC Studies.'' Journal Article. \emph{Academic Radiology} 17: 628--38. \url{https://doi.org/10.1016/j.acra.2010.01.007}.

\leavevmode\hypertarget{ref-RN621}{}%
Chakraborty, D. P., E. S. Breatnach, M. V. Yester, B. Soto, G. T. Barnes, and R. G. Fraser. 1986. ``Digital and Conventional Chest Imaging: A Modified ROC Study of Observer Performance Using Simulated Nodules.'' Journal Article. \emph{Radiology} 158: 35--39. \url{https://doi.org/10.1148/radiology.158.1.3940394}.

\leavevmode\hypertarget{ref-RN2253}{}%
Clarkson, Eric, Matthew A. Kupinski, and Harrison H. Barrett. 2006. ``A Probabilistic Model for the MRMC Method, Part 1: Theoretical Development.'' Journal Article. \emph{Academic Radiology} 13 (11): 1410--21. \url{https://doi.org/10.1016/j.acra.2006.07.016}.

\leavevmode\hypertarget{ref-cohen1988statistical}{}%
Cohen, Jacob. 1988. \emph{Statistical Power Analysis for the Behavioral Sciences}. 2nd ed. Lawrence Erlbaum Associates.

\leavevmode\hypertarget{ref-RN112}{}%
DeLong, E. R., D. M. DeLong, and D. L. Clarke-Pearson. 1988. ``Comparing the Areas Under Two or More Correlated Receiver Operating Characteristic Curves: A Nonparametric Approach.'' Journal Article. \emph{Biometrics} 44: 837--45. \url{https://doi.org/10.2307/2531595}.

\leavevmode\hypertarget{ref-RN212}{}%
Dorfman, D. D., and E. Alf. 1968. ``Maximum Likelihood Estimation of Parameters of Signal Detection Theory- a Direct Solution.'' Journal Article. \emph{Psychometrika} 33 (1): 117--24. \url{https://doi.org/10.1007/BF02289677}.

\leavevmode\hypertarget{ref-RN1081}{}%
---------. 1969. ``Maximum-Likelihood Estimation of Parameters of Signal-Detection Theory and Determination of Confidence Intervals - Rating-Method Data.'' Journal Article. \emph{Journal of Mathematical Psychology} 6: 487--96.

\leavevmode\hypertarget{ref-RN204}{}%
Dorfman, D. D., K. S. Berbaum, and C. E. Metz. 1992. ``ROC Characteristic Rating Analysis: Generalization to the Population of Readers and Patients with the Jackknife Method.'' Journal Article. \emph{Invest. Radiol.} 27 (9): 723--31. \url{https://pubmed.ncbi.nlm.nih.gov/1399456}.

\leavevmode\hypertarget{ref-RN100}{}%
Dorfman, D. D., K. S. Berbaum, C. E. Metz, R. V. Lenth, J. A. Hanley, and H. Abu Dagga. 1997. ``Proper Receiving Operating Characteristic Analysis: The Bigamma Model.'' Journal Article. \emph{Acad. Radiol.} 4 (2): 138--49. \url{https://doi.org/10.1016/S1076-6332(97)80013-X}.

\leavevmode\hypertarget{ref-RN2079}{}%
Dorfman, Donald D., Kevin S. Berbaum, and Russell V. Lenth. 1995. ``Multireader, Multicase Receiver Operating Characteristic Methodology: A Bootstrap Analysis.'' Journal Article. \emph{Academic Radiology} 2 (7): 626--33. \url{https://doi.org/10.1016/S1076-6332(05)80129-1}.

\leavevmode\hypertarget{ref-RN2080}{}%
Gallas, Brandon D. 2006. ``One-Shot Estimate of MRMC Variance: AUC.'' Journal Article. \emph{Academic Radiology} 13 (3): 353--62. \url{https://doi.org/10.1016/j.acra.2005.11.030}.

\leavevmode\hypertarget{ref-RN2351}{}%
Gallas, Brandon D., Gene a Pennello, and Kyle J. Myers. 2007. ``Multireader Multicase Variance Analysis for Binary Data.'' Journal Article. \emph{Journal of the Optical Society of America. A, Optics, Image Science, and Vision} 24 (12): 70--80. \url{https://doi.org/10.1364/josaa.24.000b70}.

\leavevmode\hypertarget{ref-RN1395}{}%
Hajian-Tilaki, K. O., James A. Hanley, L. Joseph, and J. P. Collet. 1997. ``Extension of Receiver Operating Characteristic Analysis to Data Concerning Multiple Signal Detection Tasks.'' Journal Article. \emph{Acad Radiol} 4: 222--29. \url{https://doi.org/10.1016/S1076-6332(05)80295-8}.

\leavevmode\hypertarget{ref-RN1216}{}%
Hanley, James A. 1988. ``The Robustness of the "Binormal" Assumptions Used in Fitting ROC Curves.'' Journal Article. \emph{Med. Decis. Making} 8 (3): 197--203. \url{https://doi.org/10.1177/0272989X8800800308}.

\leavevmode\hypertarget{ref-RN1772}{}%
Hillis, S. L., N. A. Obuchowski, K. M. Schartz, and K. S. Berbaum. 2005. ``A Comparison of the Dorfman-Berbaum-Metz and Obuchowski-Rockette Methods for Receiver Operating Characteristic (ROC) Data.'' Journal Article. \emph{Statistics in Medicine} 24 (10): 1579--1607. \url{https://doi.org/10.1002/sim.2024}.

\leavevmode\hypertarget{ref-RN1865}{}%
Hillis, Stephen L. 2007. ``A Comparison of Denominator Degrees of Freedom Methods for Multiple Observer ROC Studies.'' Journal Article. \emph{Statistics in Medicine} 26: 596--619. \url{https://doi.org/10.1002/sim.2532}.

\leavevmode\hypertarget{ref-RN2508}{}%
Hillis, Stephen L. 2014. ``A Marginal‐mean ANOVA Approach for Analyzing Multireader Multicase Radiological Imaging Data.'' Journal Article. \emph{Statistics in Medicine} 33 (2): 330--60. \url{https://doi.org/10.1002/sim.5926}.

\leavevmode\hypertarget{ref-RN1476}{}%
Hillis, Stephen L., and K. S. Berbaum. 2004. ``Power Estimation for the Dorfman-Berbaum-Metz Method.'' Journal Article. \emph{Acad. Radiol.} 11 (11): 1260--73. \url{https://doi.org/10.1016/j.acra.2004.08.009}.

\leavevmode\hypertarget{ref-RN1866}{}%
Hillis, Stephen L., K. S. Berbaum, and C. E. Metz. 2008. ``Recent Developments in the Dorfman-Berbaum-Metz Procedure for Multireader ROC Study Analysis.'' Journal Article. \emph{Acad Radiol} 15 (5): 647--61. \url{https://doi.org/10.1016/j.acra.2007.12.015}.

\leavevmode\hypertarget{ref-RN2137}{}%
Hillis, Stephen L., Nancy A. Obuchowski, and Kevin S. Berbaum. 2011. ``Power Estimation for Multireader ROC Methods: An Updated and Unified Approach.'' Journal Article. \emph{Academic Radiology} 18 (2): 129--42. \url{https://doi.org/10.1016/j.acra.2010.09.007}.

\leavevmode\hypertarget{ref-RN1383}{}%
ICRU. 1996. ``Medical Imaging: The Assessment of Image Quality.'' Journal Article. \emph{JOURNAL OF THE ICRU} 54 (1): 37--40.

\leavevmode\hypertarget{ref-RN2013}{}%
Ishwaran, Hemant, and Constantine A. Gatsonis. 2000. ``A General Class of Hierarchical Ordinal Regression Models with Applications to Correlated ROC Analysis.'' Journal Article. \emph{The Canadian Journal of Statistics} 28 (4): 731--50. \url{https://doi.org/10.2307/3315913}.

\leavevmode\hypertarget{ref-RN2254}{}%
Kupinski, Matthew A., Eric Clarkson, and Harrison H. Barrett. 2006. ``A Probabilistic Model for the MRMC Method, Part 2: Validation and Applications.'' Journal Article. \emph{Academic Radiology} 13 (11): 1422--30. \url{https://doi.org/10.1016/j.acra.2006.07.015}.

\leavevmode\hypertarget{ref-RN1492}{}%
Larsen, Richard J., and Morris L. Marx. 2001. \emph{An Introduction to Mathematical Statistics and Its Applications}. Book. 3rd ed. Upper Saddle River, NJ: Prentice-Hall Inc.

\leavevmode\hypertarget{ref-RN1487}{}%
Lusted, L. B. 1971. ``Signal Detectability and Medical Decision Making.'' Journal Article. \emph{Science} 171: 1217--1219. \url{https://doi.org/10.1126/science.171.3977.1217}.

\leavevmode\hypertarget{ref-RN1766}{}%
Metz, C. E. 1978. ``Basic Principles of ROC Analysis.'' Journal Article. \emph{Seminars in Nuclear Medicine} 8 (4): 283--98. \url{https://doi.org/10.1016/s0001-2998(78)80014-2}.

\leavevmode\hypertarget{ref-RN620}{}%
Niklason, L. T., N. M. Hickey, Dev P. Chakraborty, E. A. Sabbagh, M. V. Yester, R. G. Fraser, and G. T. Barnes. 1986. ``Simulated Pulmonary Nodules: Detection with Dual-Energy Digital Versus Conventional Radiography.'' Journal Article. \emph{Radiology} 160: 589--93. \url{https://doi.org/10.1148/radiology.160.3.3526398}.

\leavevmode\hypertarget{ref-RN1971}{}%
Obuchowski, Nancy A. 1998. ``Sample Size Calculations in Studies of Test Accuracy.'' Journal Article. \emph{Statistical Methods in Medical Research} 7 (4): 371--92. \url{https://doi.org/10.1177/096228029800700405}.

\leavevmode\hypertarget{ref-RN1972}{}%
---------. 2000. ``Sample Size Tables for Receiver Operating Characteristic Studies.'' Journal Article. \emph{Am. J. Roentgenol.} 175 (3): 603--8. \url{http://www.ajronline.org/cgi/content/abstract/175/3/603}.

\leavevmode\hypertarget{ref-RN1450}{}%
Obuchowski, N. A., and H. E. Rockette. 1995. ``Hypothesis Testing of the Diagnostic Accuracy for Multiple Diagnostic Tests: An ANOVA Approach with Dependent Observations.'' Journal Article. \emph{Communications in Statistics: Simulation and Computation} 24: 285--308. \url{https://doi.org/10.1080/03610919508813243}.
...
\leavevmode\hypertarget{ref-RN1784}{}%
Pisano, E. D., C. Gatsonis, E. Hendrick, M. Yaffe, J. K. Baum, S. Acharyya, E. F. Conant, et al. 2005. ``Diagnostic Performance of Digital Versus Film Mammography for Breast-Cancer Screening.'' Journal Article. \emph{N Engl J Med} 353 (17): 1773--83. \url{https://doi.org/10.1056/NEJMoa052911}.

\leavevmode\hypertarget{ref-RN300}{}%
Press, W. H., S. A. Teukolsky, W. T. Vetterling, and B. P. Flannery. 2007. \emph{Numerical Recipes: The Art of Scientific Computing}. Book. 3rd ed. Cambridge: Cambridge University Press.

\leavevmode\hypertarget{ref-RN1125}{}%
Roe, C. A., and C. E. Metz. 1997a. ``Dorfman-Berbaum-Metz Method for Statistical Analysis of Multireader, Multimodality Receiver Operating Characteristic Data: Validation with Computer Simulation.'' Journal Article. \emph{Acad Radiol} 4: 298--303. \url{https://doi.org/10.1016/S1076-6332(97)80032-3}.

\leavevmode\hypertarget{ref-RN1124}{}%
---------. 1997b. ``Variance-Component Modeling in the Analysis of Receiver Operating Characteristic Index Estimates.'' Journal Article. \emph{Acad. Radiol.} 4 (8): 587--600. \url{https://doi.org/10.1016/S1076-6332(97)80210-3}.

\leavevmode\hypertarget{ref-RN2359}{}%
Satterthwaite, F. E. 1941. ``Synthesis of Variance.'' Journal Article. \emph{Psychometrika} 6 (5): 309--16.

\leavevmode\hypertarget{ref-RN2360}{}%
---------. 1946. ``An Approximate Distribution of Estimates of Variance Components.'' Journal Article. \emph{Biometrics Bulletin} 2 (6): 110--14.

\leavevmode\hypertarget{ref-RN412}{}%
Swets, John A., and Ronald M. Pickett. 1982. \emph{Evaluation of Diagnostic Systems: Methods from Signal Detection Theory}. Book. First. Series in Cognition and Perception. New York: Academic Press.

\leavevmode\hypertarget{ref-RN1441}{}%
Toledano, A. Y. 2003. ``Three Methods for Analyzing Correlated ROC Curves: A Comparison in Real Data Sets.'' Journal Article. \emph{Statistics in Medicine} 22 (18): 2919--33. \url{https://doi.org/10.1002/sim.1518}.

\leavevmode\hypertarget{ref-RN1451}{}%
Toledano, A. Y., and C. Gatsonis. 1996. ``Ordinal Regression Methodology for ROC Curves Derived from Correlated Data.'' Journal Article. \emph{Stat Med} 15 (16): 1807--26. \url{https://doi.org/10.1002/(SICI)1097-0258(19960830)15:16\%3C1807::AID-SIM333\%3E3.0.CO;2-U}.

\leavevmode\hypertarget{ref-RN1993}{}%
Van Dyke, C. W., R. D. White, N. A. Obuchowski, M. A. Geisinger, R. J. Lorig, and M. A. Meziane. 1993. ``Cine MRI in the Diagnosis of Thoracic Aortic Dissection.'' Journal Article. \emph{79th RSNA Meetings}.

\leavevmode\hypertarget{ref-RN1882}{}%
Zanca, Federica, Jurgen Jacobs, Chantal Van Ongeval, Filip Claus, Valerie Celis, Catherine Geniets, Veerle Provost, Herman Pauwels, Guy Marchal, and Hilde Bosmans. 2009. ``Evaluation of Clinical Image Processing Algorithms Used in Digital Mammography.'' Journal Article. \emph{Medical Physics} 36 (3): 765--75. \url{https://doi.org/10.1118/1.3077121}.

\leavevmode\hypertarget{ref-zhou2009statistical}{}%
Zhou, Xiao-Hua, Donna K McClish, and Nancy A Obuchowski. 2009. \emph{Statistical Methods in Diagnostic Medicine}. Vol. 569. John Wiley \& Sons. \url{https://doi.org/110.1002/9780470906514}.
\end{cslreferences}
