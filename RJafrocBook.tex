...
The function returns a long unwieldy list. Let us consider them one by one. The function \texttt{UtilOutputReport()}, which can generate an Excel file report, making it much easier to visualize the results, is described in another chapter.
...
\texttt{ncases} is a list containing the number of cases 163 and expected power 0.8015625. Compare the number of cases to the RRRC value used in Chapter TBA.
...
\hypertarget{introduction-this-chapter-is-under-construction}{%
\section{Introduction; this chapter is under construction!}\label{introduction-this-chapter-is-under-construction}}
