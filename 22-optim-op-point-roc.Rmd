...
```{r optim-op-point-temp-AUC-vs-zeta1-10, fig.cap="Variation of AUC vs. $\\zeta_1$ for $\\lambda = 10$; AUC is the wAFROC AUC. panels are labeled by the value of $\\mu$ and zetaMax (i.e., $\\zeta_{\\text{max}}$, the value of $\\zeta_1$ that maximizes AUC).", fig.show='hold', echo=FALSE}
...
```{r optim-op-point-temp-AUC-vs-zeta1-01, fig.cap="Variation of AUC vs. $\\zeta_1$ for $\\lambda = 1$.", fig.show='hold', echo=FALSE}
...
```{r optim-op-point-temp-cad-optim-zeta1, echo=FALSE}
...
```{r optim-op-point-temp-cad-optim-table, echo=FALSE}
...
```{r optim-op-point-temp-froc-10-first-two-plots, fig.cap="Extended FROC plots: panel labeled 10-1 is for $\\lambda = 10$ and $\\mu = 1$, and that labeled 10-1.5 is for $\\lambda = 10$ and $\\mu = 1.5$. The blue line indicates the optimal operating point.", fig.show='hold', echo=FALSE, fig.height=3.5,  fig.pos='H'}
...
```{r optim-op-point-temp-froc-10-next-two-plots, fig.cap="Extended FROC plots: panel labeled 10-2 is for $\\lambda = 10$ and $\\mu = 2$ and that labeled 10-2.5 is for $\\lambda = 10$ and $\\mu = 2.5$. The blue line indicates the optimal operating point.", fig.show='hold', echo=FALSE, fig.height=3.5,  fig.pos='H'}
...
```{r optim-op-point-temp-froc-01-first-two-plots, fig.cap="Extended FROC plots: panel labeled 1-1 is for $\\lambda = 1$ and $\\mu = 1$ and that labeled 10-1.5 is for $\\lambda = 1$ and $\\mu = 1.5$. The blue line indicates the optimal operating point.", fig.show='hold', echo=FALSE, fig.height=3.5,  fig.pos='H'}
