...
## Introduction
* In the receiver operating characteristic (__ROC__) paradigm [@RN1766] the observer's task is to  __rate__ (i.e., assign an ordered label - or confidence level - representing the degree of suspicion) the case for presence of disease.
...
An actual ROC dataset [@RN1993] is included as `dataset02`, which has the following `dataset` structure:
...
<!--chapter:end:04-roi-data-format.Rmd-->
