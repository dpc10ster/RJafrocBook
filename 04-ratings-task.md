...
<div class="figure">
<img src="04-ratings-task_files/figure-html/ratings-paradigmEqVarFitA-1.png" alt="(A): The left figure is the predicted ROC curve for $\mu=1.282$ superposed on the operating points. (B): The right figure is the same data fitted with a two-parameter model described later." width="672" />
<p class="caption">(\#fig:ratings-paradigmEqVarFitA)(A): The left figure is the predicted ROC curve for $\mu=1.282$ superposed on the operating points. (B): The right figure is the same data fitted with a two-parameter model described later.</p>
</div>
