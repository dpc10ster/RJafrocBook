...
```{r, echo=FALSE,out.width="50%",out.height="20%",fig.cap="Fig. 1: Truth worksheet for file inst/extdata/toyFiles/FROC/frocCr.xlsx",fig.show='hold',fig.align='center'}
...
```{r, echo=FALSE,out.width="50%",out.height="20%",fig.cap="Fig. 2: FP/NL worksheet for file inst/extdata/toyFiles/FROC/frocCr.xlsx",fig.show='hold',fig.align='center'}
...
```{r, echo=FALSE,out.width="50%",out.height="20%",fig.cap="Fig. 3: TP/LL worksheet for file inst/extdata/toyFiles/FROC/frocCr.xlsx",fig.show='hold',fig.align='center'}
