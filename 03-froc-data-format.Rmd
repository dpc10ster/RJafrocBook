...
* The ratings of the 2 `LLs` on this case are `r dataset04$LL[1,1,1,][is.finite(dataset04$LL[1,1,1,])]`. The mean rating over all `LLs` (in all treatments and readers) is `r mean(dataset04$LL[is.finite(dataset04$LL)])`.  
```{r}
mean(is.finite(dataset04$NL[,,1:50,]))
dataset04$NL[1,1,51,]
dataset04$lesionNum[1]
