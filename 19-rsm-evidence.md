...
<div class="figure">
<img src="19-rsm-evidence_files/figure-html/rsm-evidence-binormal-plots1-1.png" alt="RSM generated ROC points using parameters and seeds specified in Table 17.2 and corresponding binormal model fitted curves." width="672" /><img src="19-rsm-evidence_files/figure-html/rsm-evidence-binormal-plots1-2.png" alt="RSM generated ROC points using parameters and seeds specified in Table 17.2 and corresponding binormal model fitted curves." width="672" />
<p class="caption">(\#fig:rsm-evidence-binormal-plots1)RSM generated ROC points using parameters and seeds specified in Table 17.2 and corresponding binormal model fitted curves.</p>
</div>
