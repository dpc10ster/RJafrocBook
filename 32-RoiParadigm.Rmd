...
```{r, echo=FALSE,out.width="50%",out.height="20%",fig.cap="Fig. 1 two views of Truth worksheet",fig.show='hold',fig.align='center'}
...
```{r, echo=FALSE,out.width="50%",out.height="20%",fig.cap="Fig. 2 two views of FP worksheet",fig.show='hold',fig.align='center'}
...
```{r, echo=FALSE,out.width="50%",out.height="20%",fig.cap="Fig. 2 TP worksheet",fig.show='hold',fig.align='center'}
