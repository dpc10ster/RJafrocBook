...
The two output lines show that the CDF of the $\chi^2$ distribution with $df = 4$ at value $chi$ = `r chi` equals 0.05, which is also the CDF of the the F-distribution with $ndf = 4$ and $ddf = \infty$ at value $chi/4$ = `r chi/4`. A little "mulling over it" should convince the reader about the truth of these statements.
