...
```{r frocSpTruth2, echo=FALSE,out.width="50%",out.height="20%",fig.cap="Two views of Truth worksheet for file frocSp.xlsx",fig.show='hold',fig.align='center'}
...
```{r frocSpLL, echo=FALSE,out.width="50%",out.height="20%",fig.cap="NL/FP worksheet, left, and LL/TP worksheet, right, for file frocSp.xlsx",fig.show='hold',fig.align='center'}
