...
## How much finished {#binary-task-how-much-finished}
85%
...
## Changing the decision threshold: Example I {#binary-task-example-1}
...
## Changing the decision threshold: Example II  {#binary-task-example-2}
...
### The chance diagonal  {#binary-task-chance-diagonal}
...
### The guessing observer {#binary-task-guessing-observer}
...
### Symmetry with respect to negative diagonal {#binary-task-symmetry-wrt-negative-diagonal}
...
### Area under the ROC curve {#binary-task-auc-roc-important}
...
### Properties of the equal-variance binormal model ROC curve {#binary-task-properties-roc}
...
### Physical interpretation of the mu-parameter {#binary-task-mu-parameter-intepretation}
