...
$$\text{Poi}_{pmf} \left (0,\lambda' \right )$$.
...
\begin{equation}
\text{FPF}\left (\zeta \right ) = \sum_{n=0}^{\infty} \text{Poi}_{pmf} \left ( n, \lambda' \right )\text{FPF}\left (\zeta \mid n \right )
...
$$\text{TPF}\left ( \zeta, \mu, \lambda', \nu' \right ) = \sum_{n=0}^{\infty} \text{Poi}_{pmf}(n,\lambda')\sum_{n=0}^{L} \text{Bin}_{pmf}(l,\nu',L) \text{TPF}_{n,l}\left ( \zeta, \mu, n, l \right )$$
...
The following truths are evident from these figures:
...
<div class="figure">
<img src="17-rsm-predictions_files/figure-html/rsm-predictions-fig-pdf-mu-plots-1.png" alt="RSM-predicted pdf curves for indicated values of the $\mu$ parameter. The solid curve corresponds to diseased cases and the dotted curve corresponds to non-diseased cases." width="672" />
