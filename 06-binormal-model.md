...
## The binormal model {#binormal-modelTheModel}
...
<img src="06-binormal-model_files/figure-html/unnamed-chunk-5-1.png" width="672" />
...
## Appendix I: Derivation of area under the binormal ROC {#binormal-model-appendix-1}
...
Then Eqn. \@ref(eq:binormal-model-partial-area-double-integral-2) simplifies to: 
...
If we perform a change of variable from $f$ to a correlation-like quantity $\rho$ (whose magnitude must be less than or equal to unity) defined by:
...
Then the argument of the right-most function $\phi$  in Eqn. \@ref(eq:binormal-model-partial-area-double-integral-3) simplifies as follows:


\begin{equation}
\frac{z_1}{f} + bz_2 = \frac{z_1 + b z_2 \sqrt{1-\rho^2}}{\sqrt{1-\rho^2}}
(\#eq:binormal-model-partial-simplification-1)
\end{equation}
...
The argument of the right-most $\phi$ function in Eqn. \@ref(eq:binormal-model-partial-simplification-1) simplifies as follows:


\begin{equation}
\frac{z_1}{f} + bz_2 = \frac{z_1 + b z_2 \sqrt{1-\rho^2}}{\sqrt{1-\rho^2}} = \frac{z_1 - \rho z_2}{\sqrt{1-\rho^2}}
(\#eq:binormal-model-partial-simplification-TBA)
\end{equation}
...
Using this form the expression for the partial area reduces to:
...
```
#> Az =  0.9408251 , max of plot =  0.9408251
```
...
## Appendix II: invariance of the binormal model to arbitrary monotone transformations {#binormal-model-appendix-2}
...
<img src="06-binormal-model_files/figure-html/unnamed-chunk-8-1.png" width="33%" /><img src="06-binormal-model_files/figure-html/unnamed-chunk-8-2.png" width="33%" /><img src="06-binormal-model_files/figure-html/unnamed-chunk-8-3.png" width="33%" /><img src="06-binormal-model_files/figure-html/unnamed-chunk-8-4.png" width="33%" /><img src="06-binormal-model_files/figure-html/unnamed-chunk-8-5.png" width="33%" /><img src="06-binormal-model_files/figure-html/unnamed-chunk-8-6.png" width="33%" /><img src="06-binormal-model_files/figure-html/unnamed-chunk-8-7.png" width="33%" /><img src="06-binormal-model_files/figure-html/unnamed-chunk-8-8.png" width="33%" /><img src="06-binormal-model_files/figure-html/unnamed-chunk-8-9.png" width="33%" />
