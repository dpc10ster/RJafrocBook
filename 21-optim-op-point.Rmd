...
Fit the LROC dataset to the RSM.
...
x1 <- cbind("wAFROC", lambda = simplePrint(lambda), zeta1 = simplePrint(zetaOptArr[1,1]), wFROC = simplePrint(maxFomArr[1,1]), ROC = simplePrint(rocAucArr[1,1]), OptOpPt = OpPtStr(nlfOptArr[1,1], llfOptArr[1,1]))
x2 <- cbind("Youden", lambda = simplePrint(lambda), zeta1 = simplePrint(zetaOptArr[2,1]), wFROC = simplePrint(maxFomArr[2,1]), ROC = simplePrint(rocAucArr[2,1]), OptOpPt = OpPtStr(nlfOptArr[2,1], llfOptArr[2,1]))
x12 <- as.data.frame(rbind(x1,x2))
colnames(x12) <- c("FOM", "lambda", "zeta1", "wAFROC", "ROC", "OptOpPt")
```
