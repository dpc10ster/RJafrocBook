...
x1 <- PlotRsmOperatingCharacteristics(mu = 1, lambda = 10, nu = 1, zeta1 = 3.25, lesDistr = lesDistr, lesWghtDistr = UtilSpecifyLesionWeightsDistr(relWeights, relWeights), legendPosition = "none")$wAFROC

x2 <- PlotRsmOperatingCharacteristics(mu = 1, lambda = 10, nu = 1, zeta1 = 1.5, lesDistr = lesDistr, lesWghtDistr = UtilSpecifyLesionWeightsDistr(relWeights, relWeights), legendPosition = "none")$wAFROC

```


```{r optim-op-point-froc-2plots, fig.cap="wAFROC plots for $\\mu = 1$, $\\lambda = 10$ and $\\nu = 1$: the left panel corresponds to $\\zeta_1 = 3.25$, the right to $\\zeta_1 = 1.5$. By reporting very few marks algorithm performance in the left plot is much improved over that in the right.", fig.show='hold', echo=FALSE, fig.height=3.5,  fig.pos='H'}
