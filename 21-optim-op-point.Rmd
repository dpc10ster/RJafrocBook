...
x1 <- PlotRsmOperatingCharacteristics(mu = 1, lambda = 10, nu = 1, zeta1 = 3.25, lesDistr = lesDistr, relWeights = relWeights, legendPosition = "none")$wAFROC

x2 <- PlotRsmOperatingCharacteristics(mu = 1, lambda = 10, nu = 1, zeta1 = 1.5, lesDistr = lesDistr, relWeights = relWeights, legendPosition = "none")$wAFROC
