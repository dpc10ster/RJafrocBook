...
CAD produces FROC data. Lacking a procedure for setting it analytically, CAD manufacturers set site-specific reporting thresholds in consultation with radiologists at the different sites. For example, if radiologists at a site are comfortable with more false marks as the price of potentially greater lesion-level sensitivity, the reporting threshold for them is adjusted downward. 
